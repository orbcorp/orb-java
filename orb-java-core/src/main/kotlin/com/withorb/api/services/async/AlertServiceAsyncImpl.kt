...
class AlertServiceAsyncImpl internal constructor(
    ...
    override fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Alert> =
        // get /alerts/{alert_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: AlertUpdateParams, requestOptions: RequestOptions): CompletableFuture<Alert> =
        // put /alerts/{alert_configuration_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: AlertListParams, requestOptions: RequestOptions): CompletableFuture<AlertListPageAsync> =
        // get /alerts
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun createForCustomer(params: AlertCreateForCustomerParams, requestOptions: RequestOptions): CompletableFuture<Alert> =
        // post /alerts/customer_id/{customer_id}
        withRawResponse().createForCustomer(params, requestOptions).thenApply { it.parse() }

    override fun createForExternalCustomer(params: AlertCreateForExternalCustomerParams, requestOptions: RequestOptions): CompletableFuture<Alert> =
    ...
    override fun createForSubscription(params: AlertCreateForSubscriptionParams, requestOptions: RequestOptions): CompletableFuture<Alert> =
    ...
    override fun disable(params: AlertDisableParams, requestOptions: RequestOptions): CompletableFuture<Alert> =
        // post /alerts/{alert_configuration_id}/disable
        withRawResponse().disable(params, requestOptions).thenApply { it.parse() }

    override fun enable(params: AlertEnableParams, requestOptions: RequestOptions): CompletableFuture<Alert> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Alert>> {
        ...
        override fun update(params: AlertUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Alert>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: AlertListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AlertListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun createForCustomer(params: AlertCreateForCustomerParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Alert>> {
          val request = HttpRequest.builder()
        ...
        override fun createForExternalCustomer(params: AlertCreateForExternalCustomerParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Alert>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun createForSubscription(params: AlertCreateForSubscriptionParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Alert>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun disable(params: AlertDisableParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Alert>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun enable(params: AlertEnableParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Alert>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
