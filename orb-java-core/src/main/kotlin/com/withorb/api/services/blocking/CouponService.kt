...
interface CouponService {
     ...
     */
    fun create(params: CouponCreateParams): Coupon =
        create(
     ...
     */
    fun archive(params: CouponArchiveParams): Coupon =
        archive(
          params, RequestOptions.none()
        )
     ...
     * parameter.
     */
    fun fetch(params: CouponFetchParams): Coupon =
        fetch(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<CouponListPage> = list(CouponListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: CouponListParams = CouponListParams.none()): HttpResponseFor<CouponListPage> =
            list(
              params, RequestOptions.none()
            )
