...
interface PlanService {
    ...
    fun create(params: PlanCreateParams): Plan =
        create(
     ...
     */
    fun update(params: PlanUpdateParams): Plan =
        update(
          params, RequestOptions.none()
        )
     ...
     */
    fun fetch(params: PlanFetchParams): Plan =
        fetch(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<PlanListPage> = list(PlanListParams.none())
