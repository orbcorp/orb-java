...
class PlanServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: PlanCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Plan>> {
        ...
        override fun update(params: PlanUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Plan>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: PlanListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PlanListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun fetch(params: PlanFetchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Plan>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("plans", params.getPathParam(0))
            .build()
