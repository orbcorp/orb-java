...
interface EventServiceAsync {
    ...
    /** @see [update] */
    fun update(params: EventUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventUpdateResponse>
    ...
    /** @see [deprecate] */
    fun deprecate(params: EventDeprecateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventDeprecateResponse>
    ...
    /** @see [ingest] */
    fun ingest(params: EventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventIngestResponse>
    ...
    /** @see [search] */
    fun search(params: EventSearchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventSearchResponse>
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun update(params: EventUpdateParams): CompletableFuture<HttpResponseFor<EventUpdateResponse>> =
            update(
              params, RequestOptions.none()
            )
        ...
        /** @see [update] */
        @MustBeClosed
        fun update(params: EventUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventUpdateResponse>>
         ...
         */
        @MustBeClosed
        fun deprecate(params: EventDeprecateParams): CompletableFuture<HttpResponseFor<EventDeprecateResponse>> =
            deprecate(
              params, RequestOptions.none()
            )
        ...
        /** @see [deprecate] */
        @MustBeClosed
        fun deprecate(params: EventDeprecateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventDeprecateResponse>>
         ...
         */
        @MustBeClosed
        fun ingest(params: EventIngestParams): CompletableFuture<HttpResponseFor<EventIngestResponse>> =
            ingest(
              params, RequestOptions.none()
            )
        ...
        /** @see [ingest] */
        @MustBeClosed
        fun ingest(params: EventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventIngestResponse>>
         ...
         */
        @MustBeClosed
        fun search(params: EventSearchParams): CompletableFuture<HttpResponseFor<EventSearchResponse>> =
            search(
              params, RequestOptions.none()
            )
        ...
        /** @see [search] */
        @MustBeClosed
        fun search(params: EventSearchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventSearchResponse>>
    }
}
