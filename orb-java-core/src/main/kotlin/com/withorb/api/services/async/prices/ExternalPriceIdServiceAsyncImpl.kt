...
class ExternalPriceIdServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun update(params: PriceExternalPriceIdUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Price>> {
        ...
        override fun fetch(params: PriceExternalPriceIdFetchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Price>> {
          val request = HttpRequest.builder()
