...
interface LedgerService {
     ...
     */
    fun createEntry(params: CustomerCreditLedgerCreateEntryParams): CustomerCreditLedgerCreateEntryResponse =
        createEntry(
          params, RequestOptions.none()
        )
     ...
     * return to the customer, up to the block's initial balance.
     */
    fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams): CustomerCreditLedgerCreateEntryByExternalIdResponse =
     ...
     * entry will be added to the ledger to indicate the adjustment of credits.
     */
    fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams): CustomerCreditLedgerListByExternalIdPage =
        listByExternalId(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(params: CustomerCreditLedgerListParams): HttpResponseFor<CustomerCreditLedgerListPage> =
            list(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun createEntry(params: CustomerCreditLedgerCreateEntryParams): HttpResponseFor<CustomerCreditLedgerCreateEntryResponse> =
            createEntry(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams): HttpResponseFor<CustomerCreditLedgerCreateEntryByExternalIdResponse> =
            createEntryByExternalId(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams): HttpResponseFor<CustomerCreditLedgerListByExternalIdPage> =
            listByExternalId(
              params, RequestOptions.none()
            )
