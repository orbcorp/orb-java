...
interface CostServiceAsync {
    ...
    /** @see [list] */
    fun list(params: CustomerCostListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerCostListResponse>
     ...
     * `grouping_value` and `secondary_grouping_value` available.
     */
    fun listByExternalId(params: CustomerCostListByExternalIdParams): CompletableFuture<CustomerCostListByExternalIdResponse> =
        listByExternalId(
          params, RequestOptions.none()
        )

    /** @see [listByExternalId] */
    fun listByExternalId(params: CustomerCostListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerCostListByExternalIdResponse>
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(params: CustomerCostListParams): CompletableFuture<HttpResponseFor<CustomerCostListResponse>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: CustomerCostListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCostListResponse>>
         ...
         */
        @MustBeClosed
        fun listByExternalId(params: CustomerCostListByExternalIdParams): CompletableFuture<HttpResponseFor<CustomerCostListByExternalIdResponse>> =
            listByExternalId(
              params, RequestOptions.none()
            )
        ...
        /** @see [listByExternalId] */
        @MustBeClosed
        fun listByExternalId(params: CustomerCostListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCostListByExternalIdResponse>>
    }
}
