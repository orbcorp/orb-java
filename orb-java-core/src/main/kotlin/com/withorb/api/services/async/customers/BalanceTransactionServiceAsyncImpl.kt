...
class BalanceTransactionServiceAsyncImpl internal constructor(
    ...
    override fun create(params: CustomerBalanceTransactionCreateParams, requestOptions: RequestOptions): CompletableFuture<CustomerBalanceTransactionCreateResponse> =
        // post /customers/{customer_id}/balance_transactions
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun list(params: CustomerBalanceTransactionListParams, requestOptions: RequestOptions): CompletableFuture<CustomerBalanceTransactionListPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CustomerBalanceTransactionCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerBalanceTransactionCreateResponse>> {
        ...
        override fun list(params: CustomerBalanceTransactionListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerBalanceTransactionListPageAsync>> {
          val request = HttpRequest.builder()
