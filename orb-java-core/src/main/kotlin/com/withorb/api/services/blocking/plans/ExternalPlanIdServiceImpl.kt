...
class ExternalPlanIdServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ExternalPlanIdService {

    private val withRawResponse: ExternalPlanIdService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ExternalPlanIdService.WithRawResponse = withRawResponse

    override fun update(params: PlanExternalPlanIdUpdateParams, requestOptions: RequestOptions): Plan =
        // put /plans/external_plan_id/{external_plan_id}
        withRawResponse().update(params, requestOptions).parse()

    override fun fetch(params: PlanExternalPlanIdFetchParams, requestOptions: RequestOptions): Plan =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun update(params: PlanExternalPlanIdUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
        ...
        override fun fetch(params: PlanExternalPlanIdFetchParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
          val request = HttpRequest.builder()
