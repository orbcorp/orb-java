...
class LedgerServiceImpl constructor(private val clientOptions: ClientOptions, ) : LedgerService {
    ...
    override fun list(params: CustomerCreditLedgerListParams, requestOptions: RequestOptions): CustomerCreditLedgerListPage {
      ...
      .let { response -> 
          ...
          .let {
              CustomerCreditLedgerListPage.of(this, params, it)
          }
      }
    }
    ...
    private val listByExternalIdHandler: Handler<CustomerCreditLedgerListByExternalIdPage.Response> =
    ...
    override fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams, requestOptions: RequestOptions): CustomerCreditLedgerListByExternalIdPage {
      ...
      .let { response -> 
          ...
          .let {
              CustomerCreditLedgerListByExternalIdPage.of(this, params, it)
          }
      }
    }
}
