...
class PriceServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PriceService {

    private val withRawResponse: PriceService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val externalPriceId: ExternalPriceIdService by lazy { ExternalPriceIdServiceImpl(clientOptions) }
    ...
    override fun evaluate(params: PriceEvaluateParams, requestOptions: RequestOptions): PriceEvaluateResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val externalPriceId: ExternalPriceIdService.WithRawResponse by lazy { ExternalPriceIdServiceImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun create(params: PriceCreateParams, requestOptions: RequestOptions): HttpResponseFor<Price> {
        ...
        override fun update(params: PriceUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Price> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<PriceListPage.Response> = jsonHandler<PriceListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: PriceListParams, requestOptions: RequestOptions): HttpResponseFor<PriceListPage> {
          val request = HttpRequest.builder()
          ...
          return response.parseable {
              ...
              .let {
                  PriceListPage.of(PriceServiceImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override fun evaluate(params: PriceEvaluateParams, requestOptions: RequestOptions): HttpResponseFor<PriceEvaluateResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun fetch(params: PriceFetchParams, requestOptions: RequestOptions): HttpResponseFor<Price> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("prices", params.getPathParam(0))
            .build()
