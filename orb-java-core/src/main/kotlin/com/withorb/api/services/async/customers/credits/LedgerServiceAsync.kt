...
interface LedgerServiceAsync {
     ...
     */
    fun list(params: CustomerCreditLedgerListParams): CompletableFuture<CustomerCreditLedgerListPageAsync> =
        list(
     ...
     */
    fun createEntry(params: CustomerCreditLedgerCreateEntryParams): CompletableFuture<CustomerCreditLedgerCreateEntryResponse> =
        createEntry(
          params, RequestOptions.none()
        )
     ...
     * return to the customer, up to the block's initial balance.
     */
    fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams): CompletableFuture<CustomerCreditLedgerCreateEntryByExternalIdResponse> =
     ...
     * entry will be added to the ledger to indicate the adjustment of credits.
     */
    fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams): CompletableFuture<CustomerCreditLedgerListByExternalIdPageAsync> =
        listByExternalId(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(params: CustomerCreditLedgerListParams): CompletableFuture<HttpResponseFor<CustomerCreditLedgerListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: CustomerCreditLedgerListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditLedgerListPageAsync>>
         ...
         */
        @MustBeClosed
        fun createEntry(params: CustomerCreditLedgerCreateEntryParams): CompletableFuture<HttpResponseFor<CustomerCreditLedgerCreateEntryResponse>> =
            createEntry(
              params, RequestOptions.none()
            )
        ...
        /** @see [createEntry] */
        @MustBeClosed
        fun createEntry(params: CustomerCreditLedgerCreateEntryParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditLedgerCreateEntryResponse>>
         ...
         */
        @MustBeClosed
        fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams): CompletableFuture<HttpResponseFor<CustomerCreditLedgerCreateEntryByExternalIdResponse>> =
            createEntryByExternalId(
              params, RequestOptions.none()
            )
        ...
        /** @see [createEntryByExternalId] */
        @MustBeClosed
        fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditLedgerCreateEntryByExternalIdResponse>>
         ...
         */
        @MustBeClosed
        fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams): CompletableFuture<HttpResponseFor<CustomerCreditLedgerListByExternalIdPageAsync>> =
            listByExternalId(
              params, RequestOptions.none()
            )
        ...
        /** @see [listByExternalId] */
        @MustBeClosed
        fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditLedgerListByExternalIdPageAsync>>
    }
}
