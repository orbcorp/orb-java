...
interface CustomerService {
     ...
     */
    fun create(params: CustomerCreateParams): Customer =
        create(
     ...
     * currently immutable.
     */
    fun update(params: CustomerUpdateParams): Customer =
        update(
          params, RequestOptions.none()
        )
     ...
     */
    fun delete(params: CustomerDeleteParams) =
        delete(
          params, RequestOptions.none()
        )
     ...
     * the Customer model.
     */
    fun fetch(params: CustomerFetchParams): Customer =
        fetch(
          params, RequestOptions.none()
        )
     ...
     * **Note**: This functionality is currently only available for Stripe.
     */
    fun syncPaymentMethodsFromGatewayByExternalCustomerId(params: CustomerSyncPaymentMethodsFromGatewayByExternalCustomerIdParams) =
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: CustomerListParams = CustomerListParams.none()): HttpResponseFor<CustomerListPage> =
            list(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun syncPaymentMethodsFromGateway(params: CustomerSyncPaymentMethodsFromGatewayParams): HttpResponse =
            syncPaymentMethodsFromGateway(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun syncPaymentMethodsFromGatewayByExternalCustomerId(params: CustomerSyncPaymentMethodsFromGatewayByExternalCustomerIdParams): HttpResponse =
            syncPaymentMethodsFromGatewayByExternalCustomerId(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun updateByExternalId(params: CustomerUpdateByExternalIdParams): HttpResponseFor<Customer> =
            updateByExternalId(
              params, RequestOptions.none()
            )
