...
interface TopUpServiceAsync {
     ...
     */
    fun create(params: CustomerCreditTopUpCreateParams): CompletableFuture<CustomerCreditTopUpCreateResponse> =
        create(
    ...
    /** List top-ups */
    fun list(params: CustomerCreditTopUpListParams): CompletableFuture<CustomerCreditTopUpListPageAsync> =
        list(
          params, RequestOptions.none()
        )
     ...
     * top-up will be replaced.
     */
    fun createByExternalId(params: CustomerCreditTopUpCreateByExternalIdParams): CompletableFuture<CustomerCreditTopUpCreateByExternalIdResponse> =
        createByExternalId(
          params, RequestOptions.none()
        )
     ...
     * credit blocks purchased through the top-up.
     */
    fun deleteByExternalId(params: CustomerCreditTopUpDeleteByExternalIdParams): CompletableFuture<Void?> =
        deleteByExternalId(
          params, RequestOptions.none()
        )
    ...
    fun listByExternalId(params: CustomerCreditTopUpListByExternalIdParams): CompletableFuture<CustomerCreditTopUpListByExternalIdPageAsync> =
        listByExternalId(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: CustomerCreditTopUpCreateParams): CompletableFuture<HttpResponseFor<CustomerCreditTopUpCreateResponse>> =
            create(
              params, RequestOptions.none()
            )
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: CustomerCreditTopUpCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditTopUpCreateResponse>>
         ...
         */
        @MustBeClosed
        fun list(params: CustomerCreditTopUpListParams): CompletableFuture<HttpResponseFor<CustomerCreditTopUpListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: CustomerCreditTopUpListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditTopUpListPageAsync>>
        ...
        /** @see [delete] */
        @MustBeClosed
        fun delete(params: CustomerCreditTopUpDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
         ...
         */
        @MustBeClosed
        fun createByExternalId(params: CustomerCreditTopUpCreateByExternalIdParams): CompletableFuture<HttpResponseFor<CustomerCreditTopUpCreateByExternalIdResponse>> =
            createByExternalId(
              params, RequestOptions.none()
            )
        ...
        /** @see [createByExternalId] */
        @MustBeClosed
        fun createByExternalId(params: CustomerCreditTopUpCreateByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditTopUpCreateByExternalIdResponse>>
         ...
         */
        @MustBeClosed
        fun deleteByExternalId(params: CustomerCreditTopUpDeleteByExternalIdParams): CompletableFuture<HttpResponse> =
            deleteByExternalId(
              params, RequestOptions.none()
            )
        ...
        /** @see [deleteByExternalId] */
        @MustBeClosed
        fun deleteByExternalId(params: CustomerCreditTopUpDeleteByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
         ...
         */
        @MustBeClosed
        fun listByExternalId(params: CustomerCreditTopUpListByExternalIdParams): CompletableFuture<HttpResponseFor<CustomerCreditTopUpListByExternalIdPageAsync>> =
            listByExternalId(
              params, RequestOptions.none()
            )
        ...
        /** @see [listByExternalId] */
        @MustBeClosed
        fun listByExternalId(params: CustomerCreditTopUpListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditTopUpListByExternalIdPageAsync>>
    }
}
