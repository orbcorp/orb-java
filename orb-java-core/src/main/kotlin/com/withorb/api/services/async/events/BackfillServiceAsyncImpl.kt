...
class BackfillServiceAsyncImpl internal constructor(
    ...
    override fun create(params: EventBackfillCreateParams, requestOptions: RequestOptions): CompletableFuture<EventBackfillCreateResponse> =
        // post /events/backfills
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun list(params: EventBackfillListParams, requestOptions: RequestOptions): CompletableFuture<EventBackfillListPageAsync> =
        // get /events/backfills
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun close(params: EventBackfillCloseParams, requestOptions: RequestOptions): CompletableFuture<EventBackfillCloseResponse> =
        // post /events/backfills/{backfill_id}/close
        withRawResponse().close(params, requestOptions).thenApply { it.parse() }

    override fun fetch(params: EventBackfillFetchParams, requestOptions: RequestOptions): CompletableFuture<EventBackfillFetchResponse> =
        // get /events/backfills/{backfill_id}
        withRawResponse().fetch(params, requestOptions).thenApply { it.parse() }

    override fun revert(params: EventBackfillRevertParams, requestOptions: RequestOptions): CompletableFuture<EventBackfillRevertResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: EventBackfillCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventBackfillCreateResponse>> {
        ...
        override fun list(params: EventBackfillListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventBackfillListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun close(params: EventBackfillCloseParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventBackfillCloseResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun fetch(params: EventBackfillFetchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventBackfillFetchResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun revert(params: EventBackfillRevertParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventBackfillRevertResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
