...
interface SubscriptionServiceAsync {
    ...
    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<SubscriptionListPageAsync> = list(SubscriptionListParams.none(), requestOptions)
    ...
    /** @see [cancel] */
    fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionCancelResponse>
    ...
    /** @see [fetch] */
    fun fetch(params: SubscriptionFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Subscription>
     ...
     * same day).
     */
    fun fetchCosts(params: SubscriptionFetchCostsParams): CompletableFuture<SubscriptionFetchCostsResponse> =
        fetchCosts(
          params, RequestOptions.none()
        )

    /** @see [fetchCosts] */
    fun fetchCosts(params: SubscriptionFetchCostsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionFetchCostsResponse>
     ...
     * changes.
     */
    fun fetchSchedule(params: SubscriptionFetchScheduleParams): CompletableFuture<SubscriptionFetchSchedulePageAsync> =
        fetchSchedule(
          params, RequestOptions.none()
        )

    /** @see [fetchSchedule] */
    fun fetchSchedule(params: SubscriptionFetchScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionFetchSchedulePageAsync>
    ...
    /** @see [fetchUsage] */
    fun fetchUsage(params: SubscriptionFetchUsageParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionUsage>
     ...
     * intervals.
     */
    fun priceIntervals(params: SubscriptionPriceIntervalsParams): CompletableFuture<SubscriptionPriceIntervalsResponse> =
        priceIntervals(
          params, RequestOptions.none()
        )

    /** @see [priceIntervals] */
    fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionPriceIntervalsResponse>
     ...
     */
    fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams): CompletableFuture<SubscriptionSchedulePlanChangeResponse> =
        schedulePlanChange(
          params, RequestOptions.none()
        )

    /** @see [schedulePlanChange] */
    fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionSchedulePlanChangeResponse>

    /**
     * Manually trigger a phase, effective the given date (or the current time, if not
     * specified).
     */
    fun triggerPhase(params: SubscriptionTriggerPhaseParams): CompletableFuture<SubscriptionTriggerPhaseResponse> =
        triggerPhase(
          params, RequestOptions.none()
        )

    /** @see [triggerPhase] */
    fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionTriggerPhaseResponse>
     ...
     */
    fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams): CompletableFuture<SubscriptionUnscheduleCancellationResponse> =
        unscheduleCancellation(
          params, RequestOptions.none()
        )

    /** @see [unscheduleCancellation] */
    fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionUnscheduleCancellationResponse>
     ...
     */
    fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams): CompletableFuture<SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse> =
        unscheduleFixedFeeQuantityUpdates(
          params, RequestOptions.none()
        )

    /** @see [unscheduleFixedFeeQuantityUpdates] */
    fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse>

    /**
     * This endpoint can be used to unschedule any pending plan changes on an existing
     * subscription.
     */
    fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams): CompletableFuture<SubscriptionUnschedulePendingPlanChangesResponse> =
        unschedulePendingPlanChanges(
          params, RequestOptions.none()
        )

    /** @see [unschedulePendingPlanChanges] */
    fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionUnschedulePendingPlanChangesResponse>
     ...
     */
    fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams): CompletableFuture<SubscriptionUpdateFixedFeeQuantityResponse> =
        updateFixedFeeQuantity(
          params, RequestOptions.none()
        )

    /** @see [updateFixedFeeQuantity] */
    fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionUpdateFixedFeeQuantityResponse>
     ...
     * extended).
     */
    fun updateTrial(params: SubscriptionUpdateTrialParams): CompletableFuture<SubscriptionUpdateTrialResponse> =
        updateTrial(
          params, RequestOptions.none()
        )

    /** @see [updateTrial] */
    fun updateTrial(params: SubscriptionUpdateTrialParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SubscriptionUpdateTrialResponse>
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SubscriptionListPageAsync>> = list(SubscriptionListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        fun cancel(params: SubscriptionCancelParams): CompletableFuture<HttpResponseFor<SubscriptionCancelResponse>> =
            cancel(
              params, RequestOptions.none()
            )
        ...
        /** @see [cancel] */
        @MustBeClosed
        fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionCancelResponse>>
         ...
         */
        @MustBeClosed
        fun fetch(params: SubscriptionFetchParams): CompletableFuture<HttpResponseFor<Subscription>> =
            fetch(
              params, RequestOptions.none()
            )
        ...
        /** @see [fetch] */
        @MustBeClosed
        fun fetch(params: SubscriptionFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Subscription>>
         ...
         */
        @MustBeClosed
        fun fetchCosts(params: SubscriptionFetchCostsParams): CompletableFuture<HttpResponseFor<SubscriptionFetchCostsResponse>> =
            fetchCosts(
              params, RequestOptions.none()
            )
        ...
        /** @see [fetchCosts] */
        @MustBeClosed
        fun fetchCosts(params: SubscriptionFetchCostsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionFetchCostsResponse>>
         ...
         */
        @MustBeClosed
        fun fetchSchedule(params: SubscriptionFetchScheduleParams): CompletableFuture<HttpResponseFor<SubscriptionFetchSchedulePageAsync>> =
            fetchSchedule(
              params, RequestOptions.none()
            )
        ...
        /** @see [fetchSchedule] */
        @MustBeClosed
        fun fetchSchedule(params: SubscriptionFetchScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionFetchSchedulePageAsync>>
         ...
         */
        @MustBeClosed
        fun fetchUsage(params: SubscriptionFetchUsageParams): CompletableFuture<HttpResponseFor<SubscriptionUsage>> =
            fetchUsage(
              params, RequestOptions.none()
            )
        ...
        /** @see [fetchUsage] */
        @MustBeClosed
        fun fetchUsage(params: SubscriptionFetchUsageParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionUsage>>
         ...
         */
        @MustBeClosed
        fun priceIntervals(params: SubscriptionPriceIntervalsParams): CompletableFuture<HttpResponseFor<SubscriptionPriceIntervalsResponse>> =
            priceIntervals(
              params, RequestOptions.none()
            )
        ...
        /** @see [priceIntervals] */
        @MustBeClosed
        fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionPriceIntervalsResponse>>
         ...
         */
        @MustBeClosed
        fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams): CompletableFuture<HttpResponseFor<SubscriptionSchedulePlanChangeResponse>> =
            schedulePlanChange(
              params, RequestOptions.none()
            )
        ...
        /** @see [schedulePlanChange] */
        @MustBeClosed
        fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionSchedulePlanChangeResponse>>
         ...
         */
        @MustBeClosed
        fun triggerPhase(params: SubscriptionTriggerPhaseParams): CompletableFuture<HttpResponseFor<SubscriptionTriggerPhaseResponse>> =
            triggerPhase(
              params, RequestOptions.none()
            )
        ...
        /** @see [triggerPhase] */
        @MustBeClosed
        fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionTriggerPhaseResponse>>
         ...
         */
        @MustBeClosed
        fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams): CompletableFuture<HttpResponseFor<SubscriptionUnscheduleCancellationResponse>> =
            unscheduleCancellation(
              params, RequestOptions.none()
            )
        ...
        /** @see [unscheduleCancellation] */
        @MustBeClosed
        fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionUnscheduleCancellationResponse>>
         ...
         */
        @MustBeClosed
        fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams): CompletableFuture<HttpResponseFor<SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse>> =
            unscheduleFixedFeeQuantityUpdates(
              params, RequestOptions.none()
            )
        ...
        /** @see [unscheduleFixedFeeQuantityUpdates] */
        @MustBeClosed
        fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse>>
         ...
         */
        @MustBeClosed
        fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams): CompletableFuture<HttpResponseFor<SubscriptionUnschedulePendingPlanChangesResponse>> =
            unschedulePendingPlanChanges(
              params, RequestOptions.none()
            )
        ...
        /** @see [unschedulePendingPlanChanges] */
        @MustBeClosed
        fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionUnschedulePendingPlanChangesResponse>>
         ...
         */
        @MustBeClosed
        fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams): CompletableFuture<HttpResponseFor<SubscriptionUpdateFixedFeeQuantityResponse>> =
            updateFixedFeeQuantity(
              params, RequestOptions.none()
            )
        ...
        /** @see [updateFixedFeeQuantity] */
        @MustBeClosed
        fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionUpdateFixedFeeQuantityResponse>>
         ...
         */
        @MustBeClosed
        fun updateTrial(params: SubscriptionUpdateTrialParams): CompletableFuture<HttpResponseFor<SubscriptionUpdateTrialResponse>> =
            updateTrial(
              params, RequestOptions.none()
            )
        ...
        /** @see [updateTrial] */
        @MustBeClosed
        fun updateTrial(params: SubscriptionUpdateTrialParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SubscriptionUpdateTrialResponse>>
    }
}
