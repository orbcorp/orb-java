...
class InvoiceLineItemServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : InvoiceLineItemService {

    private val withRawResponse: InvoiceLineItemService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): InvoiceLineItemService.WithRawResponse = withRawResponse

    override fun create(params: InvoiceLineItemCreateParams, requestOptions: RequestOptions): InvoiceLineItemCreateResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: InvoiceLineItemCreateParams, requestOptions: RequestOptions): HttpResponseFor<InvoiceLineItemCreateResponse> {
