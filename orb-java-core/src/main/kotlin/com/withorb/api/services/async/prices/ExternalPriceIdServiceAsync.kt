...
interface ExternalPriceIdServiceAsync {
    ...
    /** @see [update] */
    fun update(params: PriceExternalPriceIdUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Price>
    ...
    /** @see [fetch] */
    fun fetch(params: PriceExternalPriceIdFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Price>
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun update(params: PriceExternalPriceIdUpdateParams): CompletableFuture<HttpResponseFor<Price>> =
            update(
              params, RequestOptions.none()
            )
        ...
        /** @see [update] */
        @MustBeClosed
        fun update(params: PriceExternalPriceIdUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Price>>
         ...
         */
        @MustBeClosed
        fun fetch(params: PriceExternalPriceIdFetchParams): CompletableFuture<HttpResponseFor<Price>> =
            fetch(
              params, RequestOptions.none()
            )
        ...
        /** @see [fetch] */
        @MustBeClosed
        fun fetch(params: PriceExternalPriceIdFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Price>>
    }
}
