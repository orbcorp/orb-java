...
interface AlertServiceAsync {
     ...
     */
    fun delete(alertConfigurationId: String): CompletableFuture<Void?> =
    ...
    fun delete(
        alertConfigurationId: String,
        params: AlertDeleteParams = AlertDeleteParams.none(),
    ): CompletableFuture<Void?> = delete(alertConfigurationId, params, RequestOptions.none())
    ...
    /** @see delete */
    fun delete(params: AlertDeleteParams): CompletableFuture<Void?> =
    ...
    interface WithRawResponse {
         ...
         */
        fun delete(alertConfigurationId: String): CompletableFuture<HttpResponse> =
            delete(alertConfigurationId, AlertDeleteParams.none())
        ...
        /** @see delete */
        fun delete(params: AlertDeleteParams): CompletableFuture<HttpResponse> =
            delete(params, RequestOptions.none())
