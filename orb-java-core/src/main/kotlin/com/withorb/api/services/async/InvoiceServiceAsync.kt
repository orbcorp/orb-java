...
interface InvoiceServiceAsync {
    ...
    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<InvoiceListPageAsync> = list(InvoiceListParams.none(), requestOptions)
    ...
    /** @see [fetch] */
    fun fetch(params: InvoiceFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Invoice>
     ...
     * subscription.
     */
    fun fetchUpcoming(params: InvoiceFetchUpcomingParams): CompletableFuture<InvoiceFetchUpcomingResponse> =
        fetchUpcoming(
          params, RequestOptions.none()
        )

    /** @see [fetchUpcoming] */
    fun fetchUpcoming(params: InvoiceFetchUpcomingParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InvoiceFetchUpcomingResponse>
    ...
    /** @see [issue] */
    fun issue(params: InvoiceIssueParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Invoice>
    ...
    /** @see [markPaid] */
    fun markPaid(params: InvoiceMarkPaidParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Invoice>
    ...
    /** @see [pay] */
    fun pay(params: InvoicePayParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Invoice>
    ...
    /** @see [voidInvoice] */
    fun voidInvoice(params: InvoiceVoidInvoiceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Invoice>
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InvoiceListPageAsync>> = list(InvoiceListParams.none(), requestOptions)
        ...
        /** @see [fetch] */
        @MustBeClosed
        fun fetch(params: InvoiceFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Invoice>>
         ...
         */
        @MustBeClosed
        fun fetchUpcoming(params: InvoiceFetchUpcomingParams): CompletableFuture<HttpResponseFor<InvoiceFetchUpcomingResponse>> =
            fetchUpcoming(
              params, RequestOptions.none()
            )
        ...
        /** @see [fetchUpcoming] */
        @MustBeClosed
        fun fetchUpcoming(params: InvoiceFetchUpcomingParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<InvoiceFetchUpcomingResponse>>
        ...
        /** @see [issue] */
        @MustBeClosed
        fun issue(params: InvoiceIssueParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Invoice>>
        ...
        /** @see [markPaid] */
        @MustBeClosed
        fun markPaid(params: InvoiceMarkPaidParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Invoice>>
        ...
        /** @see [pay] */
        @MustBeClosed
        fun pay(params: InvoicePayParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Invoice>>

        /**
         * Returns a raw HTTP response for `post /invoices/{invoice_id}/void`, but is
         * otherwise the same as [InvoiceServiceAsync.voidInvoice].
         */
        @MustBeClosed
        fun voidInvoice(params: InvoiceVoidInvoiceParams): CompletableFuture<HttpResponseFor<Invoice>> =
            voidInvoice(
              params, RequestOptions.none()
            )
        ...
        /** @see [voidInvoice] */
        @MustBeClosed
        fun voidInvoice(params: InvoiceVoidInvoiceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Invoice>>
    }
}
