...
interface InvoiceServiceAsync {
     ...
     */
    @JvmOverloads
    fun list(params: InvoiceListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InvoiceListPageAsync>
     ...
     */
    @JvmOverloads
    fun void(params: InvoiceVoidParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Invoice>
}
