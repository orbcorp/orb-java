...
class EventServiceAsyncImpl internal constructor(
    ...
    override fun update(params: EventUpdateParams, requestOptions: RequestOptions): CompletableFuture<EventUpdateResponse> =
        // put /events/{event_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun deprecate(params: EventDeprecateParams, requestOptions: RequestOptions): CompletableFuture<EventDeprecateResponse> =
        // put /events/{event_id}/deprecate
        withRawResponse().deprecate(params, requestOptions).thenApply { it.parse() }

    override fun ingest(params: EventIngestParams, requestOptions: RequestOptions): CompletableFuture<EventIngestResponse> =
        // post /ingest
        withRawResponse().ingest(params, requestOptions).thenApply { it.parse() }

    override fun search(params: EventSearchParams, requestOptions: RequestOptions): CompletableFuture<EventSearchResponse> =
        // post /events/search
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun update(params: EventUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventUpdateResponse>> {
        ...
        override fun deprecate(params: EventDeprecateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventDeprecateResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
        ...
        override fun ingest(params: EventIngestParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventIngestResponse>> {
          val request = HttpRequest.builder()
        ...
        override fun search(params: EventSearchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventSearchResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
