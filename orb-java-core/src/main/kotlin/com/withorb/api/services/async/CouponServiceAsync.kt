...
interface CouponServiceAsync {
    ...
    /** @see [list] */
    fun list(params: CouponListParams = CouponListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CouponListPageAsync>

    /** @see [list] */
    fun list(params: CouponListParams = CouponListParams.none()): CompletableFuture<CouponListPageAsync> =
        list(
          params, RequestOptions.none()
        )

    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<CouponListPageAsync> = list(CouponListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: CouponCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Coupon>>
         ...
         */
        @MustBeClosed
        fun list(): CompletableFuture<HttpResponseFor<CouponListPageAsync>> = list(CouponListParams.none())

        /** @see [list] */
        @MustBeClosed
        fun list(params: CouponListParams = CouponListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CouponListPageAsync>>

        /** @see [list] */
        @MustBeClosed
        fun list(params: CouponListParams = CouponListParams.none()): CompletableFuture<HttpResponseFor<CouponListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CouponListPageAsync>> = list(CouponListParams.none(), requestOptions)
        ...
        /** @see [archive] */
        @MustBeClosed
        fun archive(params: CouponArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Coupon>>
        ...
        /** @see [fetch] */
        @MustBeClosed
        fun fetch(params: CouponFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Coupon>>
    }
}
