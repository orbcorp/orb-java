...
interface CostService {
     ...
     * `grouping_value` and `secondary_grouping_value` available.
     */
    fun listByExternalId(params: CustomerCostListByExternalIdParams): CustomerCostListByExternalIdResponse =
        listByExternalId(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun listByExternalId(params: CustomerCostListByExternalIdParams): HttpResponseFor<CustomerCostListByExternalIdResponse> =
            listByExternalId(
              params, RequestOptions.none()
            )
