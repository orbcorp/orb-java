...
class SubscriptionServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : SubscriptionServiceAsync {
     ...
     */
    override fun create(params: SubscriptionCreateParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
     ...
     */
    override fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * intervals.
     */
    override fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * specified).
     */
    override fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * subscription.
     */
    override fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions): CompletableFuture<Subscription> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
