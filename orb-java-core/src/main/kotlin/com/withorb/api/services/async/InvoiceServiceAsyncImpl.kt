...
class InvoiceServiceAsyncImpl internal constructor(
    ...
    override fun create(params: InvoiceCreateParams, requestOptions: RequestOptions): CompletableFuture<Invoice> =
        // post /invoices
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun update(params: InvoiceUpdateParams, requestOptions: RequestOptions): CompletableFuture<Invoice> =
        // put /invoices/{invoice_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: InvoiceListParams, requestOptions: RequestOptions): CompletableFuture<InvoiceListPageAsync> =
        // get /invoices
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun fetch(params: InvoiceFetchParams, requestOptions: RequestOptions): CompletableFuture<Invoice> =
        // get /invoices/{invoice_id}
        withRawResponse().fetch(params, requestOptions).thenApply { it.parse() }

    override fun fetchUpcoming(params: InvoiceFetchUpcomingParams, requestOptions: RequestOptions): CompletableFuture<InvoiceFetchUpcomingResponse> =
        // get /invoices/upcoming
        withRawResponse().fetchUpcoming(params, requestOptions).thenApply { it.parse() }

    override fun issue(params: InvoiceIssueParams, requestOptions: RequestOptions): CompletableFuture<Invoice> =
        // post /invoices/{invoice_id}/issue
        withRawResponse().issue(params, requestOptions).thenApply { it.parse() }

    override fun markPaid(params: InvoiceMarkPaidParams, requestOptions: RequestOptions): CompletableFuture<Invoice> =
        // post /invoices/{invoice_id}/mark_paid
        withRawResponse().markPaid(params, requestOptions).thenApply { it.parse() }

    override fun pay(params: InvoicePayParams, requestOptions: RequestOptions): CompletableFuture<Invoice> =
        // post /invoices/{invoice_id}/pay
        withRawResponse().pay(params, requestOptions).thenApply { it.parse() }

    override fun voidInvoice(params: InvoiceVoidInvoiceParams, requestOptions: RequestOptions): CompletableFuture<Invoice> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: InvoiceCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Invoice>> {
        ...
        override fun update(params: InvoiceUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Invoice>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: InvoiceListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InvoiceListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun fetch(params: InvoiceFetchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Invoice>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("invoices", params.getPathParam(0))
            .build()
        ...
        override fun fetchUpcoming(params: InvoiceFetchUpcomingParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InvoiceFetchUpcomingResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun issue(params: InvoiceIssueParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Invoice>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun markPaid(params: InvoiceMarkPaidParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Invoice>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun pay(params: InvoicePayParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Invoice>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        private val voidInvoiceHandler: Handler<Invoice> = jsonHandler<Invoice>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun voidInvoice(params: InvoiceVoidInvoiceParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Invoice>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
