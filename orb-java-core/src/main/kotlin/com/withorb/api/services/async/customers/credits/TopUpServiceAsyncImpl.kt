...
class TopUpServiceAsyncImpl internal constructor(
    ...
    override fun create(params: CustomerCreditTopUpCreateParams, requestOptions: RequestOptions): CompletableFuture<CustomerCreditTopUpCreateResponse> =
        // post /customers/{customer_id}/credits/top_ups
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun list(params: CustomerCreditTopUpListParams, requestOptions: RequestOptions): CompletableFuture<CustomerCreditTopUpListPageAsync> =
        // get /customers/{customer_id}/credits/top_ups
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: CustomerCreditTopUpDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /customers/{customer_id}/credits/top_ups/{top_up_id}
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun createByExternalId(params: CustomerCreditTopUpCreateByExternalIdParams, requestOptions: RequestOptions): CompletableFuture<CustomerCreditTopUpCreateByExternalIdResponse> =
    ...
    override fun deleteByExternalId(params: CustomerCreditTopUpDeleteByExternalIdParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    override fun listByExternalId(params: CustomerCreditTopUpListByExternalIdParams, requestOptions: RequestOptions): CompletableFuture<CustomerCreditTopUpListByExternalIdPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CustomerCreditTopUpCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerCreditTopUpCreateResponse>> {
        ...
        override fun list(params: CustomerCreditTopUpListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerCreditTopUpListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: CustomerCreditTopUpDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
        ...
        override fun createByExternalId(params: CustomerCreditTopUpCreateByExternalIdParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerCreditTopUpCreateByExternalIdResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun deleteByExternalId(params: CustomerCreditTopUpDeleteByExternalIdParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.DELETE)
        ...
        override fun listByExternalId(params: CustomerCreditTopUpListByExternalIdParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerCreditTopUpListByExternalIdPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("customers", "external_customer_id", params.getPathParam(0), "credits", "top_ups")
            .build()
