...
class VolumeServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : VolumeService {

    private val withRawResponse: VolumeService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun list(params: EventVolumeListParams, requestOptions: RequestOptions): HttpResponseFor<EventVolumes> {
