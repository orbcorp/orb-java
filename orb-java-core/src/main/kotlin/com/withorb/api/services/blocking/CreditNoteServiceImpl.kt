...
class CreditNoteServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CreditNoteService {

    private val withRawResponse: CreditNoteService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CreditNoteService.WithRawResponse = withRawResponse

    override fun create(params: CreditNoteCreateParams, requestOptions: RequestOptions): CreditNote =
        // post /credit_notes
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CreditNoteCreateParams, requestOptions: RequestOptions): HttpResponseFor<CreditNote> {
        ...
        private val listHandler: Handler<CreditNoteListPage.Response> = jsonHandler<CreditNoteListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: CreditNoteListParams, requestOptions: RequestOptions): HttpResponseFor<CreditNoteListPage> {
          val request = HttpRequest.builder()
          ...
          return response.parseable {
              ...
              .let {
                  CreditNoteListPage.of(CreditNoteServiceImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override fun fetch(params: CreditNoteFetchParams, requestOptions: RequestOptions): HttpResponseFor<CreditNote> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
