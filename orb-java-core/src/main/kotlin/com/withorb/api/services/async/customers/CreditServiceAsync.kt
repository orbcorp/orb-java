...
interface CreditServiceAsync {
     ...
     * currency, set `currency` to an ISO 4217 string.
     */
    fun listByExternalId(params: CustomerCreditListByExternalIdParams): CompletableFuture<CustomerCreditListByExternalIdPageAsync> =
        listByExternalId(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(params: CustomerCreditListParams): CompletableFuture<HttpResponseFor<CustomerCreditListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: CustomerCreditListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditListPageAsync>>
         ...
         */
        @MustBeClosed
        fun listByExternalId(params: CustomerCreditListByExternalIdParams): CompletableFuture<HttpResponseFor<CustomerCreditListByExternalIdPageAsync>> =
            listByExternalId(
              params, RequestOptions.none()
            )
        ...
        /** @see [listByExternalId] */
        @MustBeClosed
        fun listByExternalId(params: CustomerCreditListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreditListByExternalIdPageAsync>>
    }
}
