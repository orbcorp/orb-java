...
class PlanServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PlanService {

    private val withRawResponse: PlanService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val externalPlanId: ExternalPlanIdService by lazy { ExternalPlanIdServiceImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val externalPlanId: ExternalPlanIdService.WithRawResponse by lazy { ExternalPlanIdServiceImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun create(params: PlanCreateParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
        ...
        override fun update(params: PlanUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<PlanListPage.Response> = jsonHandler<PlanListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: PlanListParams, requestOptions: RequestOptions): HttpResponseFor<PlanListPage> {
          val request = HttpRequest.builder()
          ...
          return response.parseable {
              ...
              .let {
                  PlanListPage.of(PlanServiceImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override fun fetch(params: PlanFetchParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("plans", params.getPathParam(0))
            .build()
