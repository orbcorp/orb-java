...
interface BackfillServiceAsync {
    ...
    /** @see [create] */
    fun create(params: EventBackfillCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventBackfillCreateResponse>
    ...
    /** @see [list] */
    fun list(params: EventBackfillListParams = EventBackfillListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventBackfillListPageAsync>

    /** @see [list] */
    fun list(params: EventBackfillListParams = EventBackfillListParams.none()): CompletableFuture<EventBackfillListPageAsync> =
        list(
          params, RequestOptions.none()
        )

    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<EventBackfillListPageAsync> = list(EventBackfillListParams.none(), requestOptions)
    ...
    /** @see [close] */
    fun close(params: EventBackfillCloseParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventBackfillCloseResponse>
    ...
    /** @see [fetch] */
    fun fetch(params: EventBackfillFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventBackfillFetchResponse>
    ...
    /** @see [revert] */
    fun revert(params: EventBackfillRevertParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EventBackfillRevertResponse>
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: EventBackfillCreateParams): CompletableFuture<HttpResponseFor<EventBackfillCreateResponse>> =
            create(
              params, RequestOptions.none()
            )
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: EventBackfillCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventBackfillCreateResponse>>
         ...
         */
        @MustBeClosed
        fun list(): CompletableFuture<HttpResponseFor<EventBackfillListPageAsync>> = list(EventBackfillListParams.none())

        /** @see [list] */
        @MustBeClosed
        fun list(params: EventBackfillListParams = EventBackfillListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventBackfillListPageAsync>>

        /** @see [list] */
        @MustBeClosed
        fun list(params: EventBackfillListParams = EventBackfillListParams.none()): CompletableFuture<HttpResponseFor<EventBackfillListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EventBackfillListPageAsync>> = list(EventBackfillListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        fun close(params: EventBackfillCloseParams): CompletableFuture<HttpResponseFor<EventBackfillCloseResponse>> =
            close(
              params, RequestOptions.none()
            )
        ...
        /** @see [close] */
        @MustBeClosed
        fun close(params: EventBackfillCloseParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventBackfillCloseResponse>>
         ...
         */
        @MustBeClosed
        fun fetch(params: EventBackfillFetchParams): CompletableFuture<HttpResponseFor<EventBackfillFetchResponse>> =
            fetch(
              params, RequestOptions.none()
            )
        ...
        /** @see [fetch] */
        @MustBeClosed
        fun fetch(params: EventBackfillFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventBackfillFetchResponse>>
         ...
         */
        @MustBeClosed
        fun revert(params: EventBackfillRevertParams): CompletableFuture<HttpResponseFor<EventBackfillRevertResponse>> =
            revert(
              params, RequestOptions.none()
            )
        ...
        /** @see [revert] */
        @MustBeClosed
        fun revert(params: EventBackfillRevertParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EventBackfillRevertResponse>>
    }
}
