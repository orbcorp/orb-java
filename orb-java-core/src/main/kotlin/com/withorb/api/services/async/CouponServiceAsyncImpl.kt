...
class CouponServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CouponCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Coupon>> {
        ...
        override fun list(params: CouponListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CouponListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun archive(params: CouponArchiveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Coupon>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun fetch(params: CouponFetchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Coupon>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
