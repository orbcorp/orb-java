...
interface AlertService {
    ...
    fun retrieve(params: AlertRetrieveParams): Alert =
        retrieve(
    ...
    fun update(params: AlertUpdateParams): Alert =
        update(
          params, RequestOptions.none()
        )
     ...
     */
    fun disable(params: AlertDisableParams): Alert =
        disable(
          params, RequestOptions.none()
        )
     ...
     * `subscription_id` is not required for customer or subscription level alerts.
     */
    fun enable(params: AlertEnableParams): Alert =
        enable(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<AlertListPage> = list(AlertListParams.none())
         ...
         */
        @MustBeClosed
        fun createForExternalCustomer(params: AlertCreateForExternalCustomerParams): HttpResponseFor<Alert> =
            createForExternalCustomer(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun createForSubscription(params: AlertCreateForSubscriptionParams): HttpResponseFor<Alert> =
            createForSubscription(
              params, RequestOptions.none()
            )
