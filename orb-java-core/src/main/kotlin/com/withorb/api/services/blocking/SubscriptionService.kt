...
interface SubscriptionService {
     ...
     * given an identifier.
     */
    fun fetch(params: SubscriptionFetchParams): Subscription =
        fetch(
          params, RequestOptions.none()
        )
     ...
     * intervals.
     */
    fun priceIntervals(params: SubscriptionPriceIntervalsParams): SubscriptionPriceIntervalsResponse =
        priceIntervals(
          params, RequestOptions.none()
        )
     ...
     */
    fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams): SubscriptionSchedulePlanChangeResponse =
        schedulePlanChange(
          params, RequestOptions.none()
        )
     ...
     */
    fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams): SubscriptionUnscheduleCancellationResponse =
     ...
     */
    fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams): SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse =
     ...
     * subscription.
     */
    fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams): SubscriptionUnschedulePendingPlanChangesResponse =
     ...
     */
    fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams): SubscriptionUpdateFixedFeeQuantityResponse =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun fetchCosts(params: SubscriptionFetchCostsParams): HttpResponseFor<SubscriptionFetchCostsResponse> =
            fetchCosts(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun fetchSchedule(params: SubscriptionFetchScheduleParams): HttpResponseFor<SubscriptionFetchSchedulePage> =
            fetchSchedule(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun priceIntervals(params: SubscriptionPriceIntervalsParams): HttpResponseFor<SubscriptionPriceIntervalsResponse> =
            priceIntervals(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams): HttpResponseFor<SubscriptionSchedulePlanChangeResponse> =
            schedulePlanChange(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun triggerPhase(params: SubscriptionTriggerPhaseParams): HttpResponseFor<SubscriptionTriggerPhaseResponse> =
            triggerPhase(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams): HttpResponseFor<SubscriptionUnscheduleCancellationResponse> =
            unscheduleCancellation(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams): HttpResponseFor<SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse> =
            unscheduleFixedFeeQuantityUpdates(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams): HttpResponseFor<SubscriptionUnschedulePendingPlanChangesResponse> =
            unschedulePendingPlanChanges(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams): HttpResponseFor<SubscriptionUpdateFixedFeeQuantityResponse> =
            updateFixedFeeQuantity(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun updateTrial(params: SubscriptionUpdateTrialParams): HttpResponseFor<SubscriptionUpdateTrialResponse> =
            updateTrial(
              params, RequestOptions.none()
            )
