...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = subscriptionUsage.accept(new SubscriptionUsage.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitUngrouped(UngroupedSubscriptionUsage ungrouped) {
     *         return Optional.of(ungrouped.toString());
     *     }
     *
     *     // ...
     *
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (billableMetric.asKnown().getOrNull()?.validity() ?: 0) +
                    (usage.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (billableMetric.asKnown().getOrNull()?.validity() ?: 0) +
                    (metricGroup.asKnown().getOrNull()?.validity() ?: 0) +
                    (usage.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                    (viewMode.asKnown().getOrNull()?.validity() ?: 0)
