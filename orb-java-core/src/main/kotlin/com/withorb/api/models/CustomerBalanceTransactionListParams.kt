...
class CustomerBalanceTransactionListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun operationTimeGt(operationTimeGt: Optional<OffsetDateTime>) = operationTimeGt(operationTimeGt.getOrNull())
        ...
        fun operationTimeGte(operationTimeGte: Optional<OffsetDateTime>) = operationTimeGte(operationTimeGte.getOrNull())
        ...
        fun operationTimeLt(operationTimeLt: Optional<OffsetDateTime>) = operationTimeLt(operationTimeLt.getOrNull())
        ...
        fun operationTimeLte(operationTimeLte: Optional<OffsetDateTime>) = operationTimeLte(operationTimeLte.getOrNull())
