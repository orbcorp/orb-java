...
private constructor(
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun planVersionDescription(): Optional<String> =
            planVersionDescription.getOptional("plan_version_description")
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.planVersionDescription] with
             * `planVersionDescription.orElse(null)`.
             */
            fun planVersionDescription(planVersionDescription: Optional<String>) =
                planVersionDescription(planVersionDescription.getOrNull())
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (planVersionDescription.asKnown().isPresent) 1 else 0) +
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PLAN_VERSION_CREATED = of("plan.version_created")
