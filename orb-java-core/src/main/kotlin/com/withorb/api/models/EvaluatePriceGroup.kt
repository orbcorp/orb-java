...
private constructor(
    ...
    internal fun validity(): Int =
        (if (amount.asKnown().isPresent) 1 else 0) +
            (groupingValues.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = groupingValue.accept(new GroupingValue.Visitor<Optional<String>>() {
         *     @Override
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<Double>())?.let {
                                GroupingValue(number = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<Boolean>())?.let {
                                GroupingValue(bool = it, _json = json)
                            },
                        )
                        .filterNotNull()
