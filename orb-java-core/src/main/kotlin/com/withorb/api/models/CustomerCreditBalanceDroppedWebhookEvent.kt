...
private constructor(
    ...
    private constructor(
         ...
         */
        fun pricingUnit(): Optional<PricingUnit> = pricingUnit.getOptional("pricing_unit")
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [Builder.pricingUnit] with `pricingUnit.orElse(null)`. */
            fun pricingUnit(pricingUnit: Optional<PricingUnit>) =
                pricingUnit(pricingUnit.getOrNull())
        ...
        fun validate(): Properties = apply {
            ...
            balanceThreshold()
            pricingUnit().ifPresent { it.validate() }
            validated = true
        }
        ...
        internal fun validity(): Int =
            (alertConfiguration.asKnown().getOrNull()?.validity() ?: 0) +
                (if (balanceThreshold.asKnown().isPresent) 1 else 0) +
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CUSTOMER_CREDIT_BALANCE_DROPPED = of("customer.credit_balance_dropped")
