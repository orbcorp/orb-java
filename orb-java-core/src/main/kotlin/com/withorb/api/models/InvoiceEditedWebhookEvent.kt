...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *   server responded with an unexpected value).
             */
            fun discounts(): Optional<List<InvoiceLevelDiscount>> =
             ...
             *   server responded with an unexpected value).
             */
            fun dueDate(): Optional<String> = dueDate.getOptional("due_date")
            ...
            class Builder internal constructor() {
                ...
                fun discounts(discounts: Optional<List<InvoiceLevelDiscount>>) =
                ...
                fun dueDate(dueDate: Optional<String>) = dueDate(dueDate.getOrNull())
                ...
                fun lineItems(lineItems: Optional<List<LineItem>>) =
                    lineItems(lineItems.getOrNull())
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    /**
                     * Alias for calling [Builder.usageCustomerIds] with
                     * `usageCustomerIds.orElse(null)`.
                     */
                ...
                private constructor(
                    ...
                    fun minimum(): Optional<MonetaryMinimumAdjustment> =
                        Optional.ofNullable(minimum)

                    fun maximum(): Optional<MonetaryMaximumAdjustment> =
                    ...
                    private constructor(
                        ...
                        internal fun validity(): Int =
                            (if (id.asKnown().isPresent) 1 else 0) +
                                ...
                                (filters.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                                    ?: 0) +
                        ...
                        private constructor(
                             ...
                             */
                            fun upperBound(): Optional<Double> =
                                upperBound.getOptional("upper_bound")
                            ...
                            class Builder internal constructor() {
                                ...
                                /**
                                 * Alias for calling [Builder.upperBound] with
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val INVOICE_EDITED = of("invoice.edited")
