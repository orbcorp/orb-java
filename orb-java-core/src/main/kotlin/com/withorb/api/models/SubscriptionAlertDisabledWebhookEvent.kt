...
private constructor(
    ...
    private constructor(
         ...
         */
        fun cardinality(): Optional<Long> = cardinality.getOptional("cardinality")

        /**
         * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun cardinalityLimit(): Optional<Long> = cardinalityLimit.getOptional("cardinality_limit")
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [Builder.cardinality] with `cardinality.orElse(null)`. */
            fun cardinality(cardinality: Optional<Long>) = cardinality(cardinality.getOrNull())
            ...
            /**
             * Alias for calling [Builder.cardinalityLimit] with `cardinalityLimit.orElse(null)`.
             */
            fun cardinalityLimit(cardinalityLimit: Optional<Long>) =
                cardinalityLimit(cardinalityLimit.getOrNull())
        ...
        internal fun validity(): Int =
            (alertConfiguration.asKnown().getOrNull()?.validity() ?: 0) +
                (if (cardinality.asKnown().isPresent) 1 else 0) +
                (if (cardinalityLimit.asKnown().isPresent) 1 else 0) +
        ...
        class Reason @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val SYSTEM_CARDINALITY_LIMIT = of("system_cardinality_limit")
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SUBSCRIPTION_ALERT_DISABLED = of("subscription.alert_disabled")
