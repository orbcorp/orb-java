...
private constructor(
    ...
    constructor(
        ...
        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<PriceModel>>> = Optional.ofNullable(data)
    ...
    class AutoPager(private val firstPage: PriceListPageAsync) {
        ...
        fun forEach(action: Predicate<PriceModel>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<PriceListPageAsync>>.forEach(
                action: (PriceModel) -> Boolean,
                executor: Executor,
        ...
        fun toList(executor: Executor): CompletableFuture<List<PriceModel>> {
            val values = mutableListOf<PriceModel>()
