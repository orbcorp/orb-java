...
class SubscriptionFetchSchedulePageAsync private constructor(
    ...
    class AutoPager(
        ...
        fun forEach(action: Predicate<SubscriptionFetchScheduleResponse>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<SubscriptionFetchSchedulePageAsync>>.forEach(action: (SubscriptionFetchScheduleResponse) -> Boolean, executor: Executor): CompletableFuture<Void> =
              thenComposeAsync(
                { page ->
                    page
                    .filter {
