...
private constructor(
    ...
    private constructor(
        ...
        fun groupedTieredMatrix(): Optional<GroupedTieredMatrix> =
            Optional.ofNullable(groupedTieredMatrix)
        ...
        fun meteredAllowance(): Optional<MeteredAllowance> = Optional.ofNullable(meteredAllowance)
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (cadence.asKnown().getOrNull()?.validity() ?: 0) +
                    (if (currency.asKnown().isPresent) 1 else 0) +
                    (groupedTieredMatrixConfig.asKnown().getOrNull()?.validity() ?: 0) +
                    (if (itemId.asKnown().isPresent) 1 else 0) +
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (cadence.asKnown().getOrNull()?.validity() ?: 0) +
                    (if (currency.asKnown().isPresent) 1 else 0) +
                    (if (itemId.asKnown().isPresent) 1 else 0) +
                    (matrixWithThresholdDiscountsConfig.asKnown().getOrNull()?.validity() ?: 0) +
                    modelType.let {
                ...
                private constructor(
                    ...
                    internal fun validity(): Int =
                        (if (aboveThresholdDiscountPercentage.asKnown().isPresent) 1 else 0) +
                            (if (belowThresholdDiscountPercentage.asKnown().isPresent) 1 else 0) +
