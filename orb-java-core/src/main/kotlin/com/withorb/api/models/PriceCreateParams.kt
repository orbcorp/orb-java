...
class PriceCreateParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    fun newFloatingGroupedWithProratedMinimumPrice(): Optional<NewFloatingGroupedWithProratedMinimumPrice> = Optional.ofNullable(newFloatingGroupedWithProratedMinimumPrice)
