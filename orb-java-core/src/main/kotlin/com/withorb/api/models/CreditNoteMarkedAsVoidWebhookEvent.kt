...
private constructor(
     ...
     * ```java
     * MyClass myObject = creditNoteMarkedAsVoidWebhookEvent.properties().convert(MyClass.class);
     * ```
     */
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CREDIT_NOTE_MARKED_AS_VOID = of("credit_note.marked_as_void")
