...
class CustomerCreditLedgerListByExternalIdPageAsync private constructor(
    ...
    class AutoPager(
        ...
        fun forEach(action: Predicate<CustomerCreditLedgerListByExternalIdResponse>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<CustomerCreditLedgerListByExternalIdPageAsync>>.forEach(action: (CustomerCreditLedgerListByExternalIdResponse) -> Boolean, executor: Executor): CompletableFuture<Void> =
              thenComposeAsync(
                { page ->
                    page
                    .filter {
