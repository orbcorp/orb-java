...
private constructor(
    ...
    private constructor(
         ...
         */
        fun creditNoteId(): Optional<String> = creditNoteId.getOptional("credit_note_id")
        ...
        class Builder internal constructor() {
            ...
            fun creditNoteId(creditNoteId: Optional<String>) =
                creditNoteId(creditNoteId.getOrNull())
        ...
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) +
                ...
                (if (creditNoteId.asKnown().isPresent) 1 else 0) +
