...
private constructor(
    ...
    class AutoPager(private val firstPage: AlertListPageAsync) {
        ...
        fun forEach(action: Predicate<AlertModel>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<AlertListPageAsync>>.forEach(
                action: (AlertModel) -> Boolean,
                executor: Executor,
        ...
        fun toList(executor: Executor): CompletableFuture<List<AlertModel>> {
            val values = mutableListOf<AlertModel>()
