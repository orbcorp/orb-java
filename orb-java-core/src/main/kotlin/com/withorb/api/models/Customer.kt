...
class Customer @JsonCreator private constructor(
    ...
    fun exemptFromAutomatedTax(): Optional<Boolean> = Optional.ofNullable(exemptFromAutomatedTax.getNullable("exempt_from_automated_tax"))
    ...
    class Builder internal constructor() {
        ...
        fun exemptFromAutomatedTax(exemptFromAutomatedTax: Optional<Boolean>) = exemptFromAutomatedTax(exemptFromAutomatedTax.getOrNull())
    ...
    class AccountingSyncConfiguration @JsonCreator private constructor(
        ...
        class AccountingProvider @JsonCreator private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun externalProviderId(externalProviderId: Optional<String>) = externalProviderId(externalProviderId.getOrNull())
