...
private constructor(
     ...
     * ```java
     * MyClass myObject = invoiceManuallyMarkedAsVoidWebhookEvent.properties().convert(MyClass.class);
     * ```
     */
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val INVOICE_MANUALLY_MARKED_AS_VOID = of("invoice.manually_marked_as_void")
