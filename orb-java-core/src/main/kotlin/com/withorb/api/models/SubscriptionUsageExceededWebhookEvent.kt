...
private constructor(
    ...
    private constructor(
         ...
         */
        fun evaluatedQuantity(): Optional<Double> =
            evaluatedQuantity.getOptional("evaluated_quantity")

        /**
         * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun quantityThreshold(): Optional<Double> =
            quantityThreshold.getOptional("quantity_threshold")
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.evaluatedQuantity] with `evaluatedQuantity.orElse(null)`.
             */
            fun evaluatedQuantity(evaluatedQuantity: Optional<Double>) =
                evaluatedQuantity(evaluatedQuantity.getOrNull())
            ...
            /**
             * Alias for calling [Builder.quantityThreshold] with `quantityThreshold.orElse(null)`.
             */
            fun quantityThreshold(quantityThreshold: Optional<Double>) =
                quantityThreshold(quantityThreshold.getOrNull())
        ...
        internal fun validity(): Int =
            (alertConfiguration.asKnown().getOrNull()?.validity() ?: 0) +
                ...
                (if (evaluatedQuantity.asKnown().isPresent) 1 else 0) +
                (if (quantityThreshold.asKnown().isPresent) 1 else 0) +
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SUBSCRIPTION_USAGE_EXCEEDED = of("subscription.usage_exceeded")
