...
private constructor(
     ...
     */
    fun price(): Optional<PriceModel> = Optional.ofNullable(price.getNullable("price"))
    ...
    class Builder internal constructor() {
         ...
         * [the core concepts documentation](/core-concepts#plan-and-price)
         */
        fun price(price: Optional<PriceModel>) = price(price.orElse(null))
    ...
    private constructor(
        ...
        private constructor(
            ...
            fun grouping(): Optional<SubLineItemGroupingModel> =
            ...
            class Builder internal constructor() {
                ...
                fun grouping(grouping: Optional<SubLineItemGroupingModel>) =
                    grouping(grouping.orElse(null))
