...
private constructor(
     ...
     * ```java
     * MyClass myObject = backfillReflectedWebhookEvent.properties().convert(MyClass.class);
     * ```
     */
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            (backfill.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun revertedAt(revertedAt: Optional<OffsetDateTime>) =
                revertedAt(revertedAt.getOrNull())
        ...
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) +
                ...
                (if (eventsIngested.asKnown().isPresent) 1 else 0) +
                (if (replaceExistingEvents.asKnown().isPresent) 1 else 0) +
                (if (revertedAt.asKnown().isPresent) 1 else 0) +
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val BACKFILL_REFLECTED = of("backfill.reflected")
