...
private constructor(
    ...
    constructor(
        ...
        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<CustomerModel>>> = Optional.ofNullable(data)
    ...
    class AutoPager(private val firstPage: CustomerListPageAsync) {
        ...
        fun forEach(action: Predicate<CustomerModel>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<CustomerListPageAsync>>.forEach(
                action: (CustomerModel) -> Boolean,
                executor: Executor,
        ...
        fun toList(executor: Executor): CompletableFuture<List<CustomerModel>> {
            val values = mutableListOf<CustomerModel>()
