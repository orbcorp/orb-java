...
class CustomerCreditLedgerCreateEntryParams private constructor(
    ...
    class Body private constructor(
        ...
        class AddIncrementCreditLedgerEntryRequestParams @JsonCreator private constructor(
             ...
             * basis.
             */
            fun invoiceSettings(): Optional<InvoiceSettings> = Optional.ofNullable(invoiceSettings.getNullable("invoice_settings"))
            ...
            class Builder internal constructor() {
                 ...
                 * available for use.
                 */
                fun effectiveDate(effectiveDate: Optional<OffsetDateTime>) = effectiveDate(effectiveDate.getOrNull())
                 ...
                 * basis.
                 */
                fun invoiceSettings(invoiceSettings: Optional<InvoiceSettings>) = invoiceSettings(invoiceSettings.getOrNull())
        ...
        class AddVoidCreditLedgerEntryRequestParams @JsonCreator private constructor(
            ...
            fun voidReason(): Optional<VoidReason> = Optional.ofNullable(voidReason.getNullable("void_reason"))
            ...
            class Builder internal constructor() {
                ...
                /** Can only be specified when `entry_type=void`. The reason for the void. */
                fun voidReason(voidReason: Optional<VoidReason>) = voidReason(voidReason.getOrNull())
