...
private constructor(
    ...
    private constructor(
        ...
        fun redeemedCoupon(): Optional<RedeemedCoupon> =
            redeemedCoupon.getOptional("redeemed_coupon")
        ...
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) +
                ...
                (fixedFeeQuantitySchedule.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                    ?: 0) +
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 */
                fun currentBillingPeriodEndDate(
                    currentBillingPeriodEndDate: Optional<OffsetDateTime>
                ) = currentBillingPeriodEndDate(currentBillingPeriodEndDate.getOrNull())
            ...
            internal fun validity(): Int =
                (if (id.asKnown().isPresent) 1 else 0) +
                    ...
                    (fixedFeeQuantityTransitions.asKnown().getOrNull()?.sumOf {
                        it.validity().toInt()
                    } ?: 0) +
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (createdCreditNotes.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                    ...
                    (voidedCreditNotes.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                        ?: 0) +
