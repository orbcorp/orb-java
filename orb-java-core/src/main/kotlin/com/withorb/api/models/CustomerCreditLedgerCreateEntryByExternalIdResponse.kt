...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = customerCreditLedgerCreateEntryByExternalIdResponse.accept(new CustomerCreditLedgerCreateEntryByExternalIdResponse.Visitor<Optional<String>>() {
     *     @Override
