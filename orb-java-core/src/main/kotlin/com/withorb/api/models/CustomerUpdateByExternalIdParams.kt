...
class CustomerUpdateByExternalIdParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun accountingSyncConfiguration(): Optional<AccountingSyncConfiguration> = Optional.ofNullable(accountingSyncConfiguration)
    ...
    fun reportingConfiguration(): Optional<ReportingConfiguration> = Optional.ofNullable(reportingConfiguration)
