...
class CustomerUpdateByExternalIdParams private constructor(
    ...
    fun accountingSyncConfiguration(): Optional<AccountingSyncConfiguration> = body.accountingSyncConfiguration()
    ...
    class Body @JsonCreator private constructor(
         ...
         * addresses will be CC'd for customer communications.
         */
        fun additionalEmails(): Optional<List<String>> = Optional.ofNullable(additionalEmails.getNullable("additional_emails"))
        ...
        fun emailDelivery(): Optional<Boolean> = Optional.ofNullable(emailDelivery.getNullable("email_delivery"))
        ...
        /** The hierarchical relationships for this customer. */
        fun hierarchy(): Optional<Hierarchy> = Optional.ofNullable(hierarchy.getNullable("hierarchy"))
        ...
        fun taxConfiguration(): Optional<TaxConfiguration> = Optional.ofNullable(taxConfiguration.getNullable("tax_configuration"))
        ...
        class Builder internal constructor() {
            ...
            fun accountingSyncConfiguration(accountingSyncConfiguration: Optional<AccountingSyncConfiguration>) = accountingSyncConfiguration(accountingSyncConfiguration.getOrNull())
             ...
             * addresses will be CC'd for customer communications.
             */
            fun additionalEmails(additionalEmails: Optional<List<String>>) = additionalEmails(additionalEmails.getOrNull())
            ...
            fun billingAddress(billingAddress: Optional<BillingAddress>) = billingAddress(billingAddress.getOrNull())
            ...
            fun emailDelivery(emailDelivery: Optional<Boolean>) = emailDelivery(emailDelivery.getOrNull())
             ...
             *   the Orb team.
             */
            fun paymentProvider(paymentProvider: Optional<PaymentProvider>) = paymentProvider(paymentProvider.getOrNull())
             ...
             * is used for creating charges or invoices in the external system via Orb.
             */
            fun paymentProviderId(paymentProviderId: Optional<String>) = paymentProviderId(paymentProviderId.getOrNull())
            ...
            fun reportingConfiguration(reportingConfiguration: Optional<ReportingConfiguration>) = reportingConfiguration(reportingConfiguration.getOrNull())
            ...
            fun shippingAddress(shippingAddress: Optional<ShippingAddress>) = shippingAddress(shippingAddress.getOrNull())
            ...
            fun taxConfiguration(taxConfiguration: Optional<TaxConfiguration>) = taxConfiguration(taxConfiguration.getOrNull())
    ...
    class AccountingSyncConfiguration @JsonCreator private constructor(
        ...
        fun accountingProviders(): Optional<List<AccountingProvider>> = Optional.ofNullable(accountingProviders.getNullable("accounting_providers"))
        ...
        class Builder internal constructor() {
            ...
            fun accountingProviders(accountingProviders: Optional<List<AccountingProvider>>) = accountingProviders(accountingProviders.getOrNull())
    ...
    class Hierarchy @JsonCreator private constructor(
         ...
         */
        fun childCustomerIds(): Optional<List<String>> = Optional.ofNullable(childCustomerIds.getNullable("child_customer_ids"))

        /**
         * The ID of the parent customer in the hierarchy. The desired parent customer must
         * not be a child of another customer.
         */
        fun parentCustomerId(): Optional<String> = Optional.ofNullable(parentCustomerId.getNullable("parent_customer_id"))
        ...
        class Builder internal constructor() {
             ...
             * not be a child of another customer.
             */
            fun parentCustomerId(parentCustomerId: Optional<String>) = parentCustomerId(parentCustomerId.getOrNull())
    ...
    class TaxConfiguration private constructor(
        ...
        internal class Deserializer : BaseDeserializer<TaxConfiguration>(TaxConfiguration::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): TaxConfiguration {
              ...
              val taxProvider = json.asObject().getOrNull()?.get("tax_provider")?.asString()?.getOrNull()
        ...
        class NewAvalaraTaxConfiguration @JsonCreator private constructor(
            ...
            fun taxExemptionCode(): Optional<String> = Optional.ofNullable(taxExemptionCode.getNullable("tax_exemption_code"))
            ...
            class Builder internal constructor() {
                ...
                fun taxExemptionCode(taxExemptionCode: Optional<String>) = taxExemptionCode(taxExemptionCode.getOrNull())
