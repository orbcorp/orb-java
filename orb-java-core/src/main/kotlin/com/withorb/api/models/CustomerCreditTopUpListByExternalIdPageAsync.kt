...
class CustomerCreditTopUpListByExternalIdPageAsync private constructor(
    ...
    class AutoPager(
        ...
        fun forEach(action: Predicate<CustomerCreditTopUpListByExternalIdResponse>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<CustomerCreditTopUpListByExternalIdPageAsync>>.forEach(action: (CustomerCreditTopUpListByExternalIdResponse) -> Boolean, executor: Executor): CompletableFuture<Void> =
              thenComposeAsync(
                { page ->
                    page
                    .filter {
