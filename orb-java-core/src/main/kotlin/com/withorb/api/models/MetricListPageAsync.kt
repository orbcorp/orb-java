...
private constructor(
    ...
    constructor(
        ...
        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<BillableMetricModel>>> = Optional.ofNullable(data)
    ...
    class AutoPager(private val firstPage: MetricListPageAsync) {
        ...
        fun forEach(
            action: Predicate<BillableMetricModel>,
            executor: Executor,
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<MetricListPageAsync>>.forEach(
                action: (BillableMetricModel) -> Boolean,
                executor: Executor,
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<BillableMetricModel>> {
            val values = mutableListOf<BillableMetricModel>()
