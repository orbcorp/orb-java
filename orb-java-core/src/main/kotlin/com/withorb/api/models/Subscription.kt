...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = discountInterval.accept(new DiscountInterval.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitAmount(AmountDiscountInterval amount) {
