...
class CustomerCreditListByExternalIdPageAsync private constructor(
    ...
    class AutoPager(
        ...
        fun forEach(action: Predicate<CustomerCreditListByExternalIdResponse>, executor: Executor): CompletableFuture<Void> {
          fun CompletableFuture<Optional<CustomerCreditListByExternalIdPageAsync>>.forEach(action: (CustomerCreditListByExternalIdResponse) -> Boolean, executor: Executor): CompletableFuture<Void> =
              thenComposeAsync(
                { page ->
                    page
                    .filter {
