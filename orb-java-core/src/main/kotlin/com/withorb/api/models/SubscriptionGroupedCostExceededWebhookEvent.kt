...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *   server responded with an unexpected value).
             */
            fun amountThreshold(): Optional<String> =
                amountThreshold.getOptional("amount_threshold")

            /**
             * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
             *   server responded with an unexpected value).
             */
            fun evaluatedAmount(): Optional<String> =
                evaluatedAmount.getOptional("evaluated_amount")
