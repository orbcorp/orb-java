...
private constructor(
    ...
    fun pathExternalDimensionalPriceGroupId(): Optional<String> =
     ...
     */
    fun bodyExternalDimensionalPriceGroupId(): Optional<String> =
    ...
    class Builder internal constructor() {
        ...
        fun pathExternalDimensionalPriceGroupId(
            pathExternalDimensionalPriceGroupId: Optional<String>
        ...
        fun bodyExternalDimensionalPriceGroupId(
            bodyExternalDimensionalPriceGroupId: Optional<String>
