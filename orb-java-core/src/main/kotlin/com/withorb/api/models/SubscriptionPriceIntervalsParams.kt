...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = startDate.accept(new StartDate.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitDateTime(OffsetDateTime dateTime) {
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = discount.accept(new Discount.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitAmount(Amount amount) {
             *         return Optional.of(amount.toString());
             *     }
             *
             *     // ...
             *
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = endDate.accept(new EndDate.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitDateTime(OffsetDateTime dateTime) {
             *         return Optional.of(dateTime.toString());
             *     }
    ...
    private constructor(
        ...
        private constructor(
             ...
             *     @Override
             *     public Optional<String> visitPercentageDiscount(NewPercentageDiscount percentageDiscount) {
             *         return Optional.of(percentageDiscount.toString());
             *     }
             *
             *     // ...
             *
