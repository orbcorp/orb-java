...
class ItemServiceAsyncTest {
    ...
    fun create() {
      ...
      val itemFuture = itemServiceAsync.create(ItemCreateParams.builder()
          .name("API requests")
          .build())
    ...
    fun update() {
      ...
      val itemFuture = itemServiceAsync.update(ItemUpdateParams.builder()
          .itemId("item_id")
    ...
    fun fetch() {
      ...
      val itemFuture = itemServiceAsync.fetch(ItemFetchParams.builder()
          .itemId("item_id")
          .build())
