...
class EventServiceTest {
    ...
    fun update() {
      ...
      val event = eventService.update(EventUpdateParams.builder()
          .eventId("event_id")
    ...
    fun deprecate() {
      ...
      val response = eventService.deprecate(EventDeprecateParams.builder()
          .eventId("event_id")
          .build())
    ...
    fun ingest() {
      ...
      val response = eventService.ingest(EventIngestParams.builder()
    ...
    fun search() {
      ...
      val response = eventService.search(EventSearchParams.builder()
          .addEventId("string")
