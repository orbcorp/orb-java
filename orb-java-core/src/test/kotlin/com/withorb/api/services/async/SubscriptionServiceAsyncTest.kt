...
class SubscriptionServiceAsyncTest {
    ...
    fun create() {
        ...
        val mutatedSubscriptionModelFuture =
        ...
        val mutatedSubscriptionModel = mutatedSubscriptionModelFuture.get()
    ...
    fun update() {
        ...
        val subscriptionModel = subscriptionModelFuture.get()
