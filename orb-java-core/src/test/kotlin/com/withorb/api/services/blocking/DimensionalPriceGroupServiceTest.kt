...
class DimensionalPriceGroupServiceTest {
    ...
    fun create() {
      ...
      val dimensionalPriceGroup = dimensionalPriceGroupService.create(DimensionalPriceGroupCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val dimensionalPriceGroup = dimensionalPriceGroupService.retrieve(DimensionalPriceGroupRetrieveParams.builder()
