...
class CustomerServiceAsyncTest {
    ...
    fun delete() {
      ...
      val future = customerServiceAsync.delete(CustomerDeleteParams.builder()
          .customerId("customer_id")
          .build())
    ...
    fun fetch() {
      ...
      val customerFuture = customerServiceAsync.fetch(CustomerFetchParams.builder()
          .customerId("customer_id")
          .build())
    ...
    fun fetchByExternalId() {
      ...
      val customerFuture = customerServiceAsync.fetchByExternalId(CustomerFetchByExternalIdParams.builder()
          .externalCustomerId("external_customer_id")
          .build())
    ...
    fun syncPaymentMethodsFromGateway() {
      ...
      val future = customerServiceAsync.syncPaymentMethodsFromGateway(CustomerSyncPaymentMethodsFromGatewayParams.builder()
          .externalCustomerId("external_customer_id")
          .build())
    ...
    fun syncPaymentMethodsFromGatewayByExternalCustomerId() {
      ...
      val future = customerServiceAsync.syncPaymentMethodsFromGatewayByExternalCustomerId(CustomerSyncPaymentMethodsFromGatewayByExternalCustomerIdParams.builder()
          .customerId("customer_id")
          .build())
    ...
    fun updateByExternalId() {
      ...
      val customerFuture = customerServiceAsync.updateByExternalId(CustomerUpdateByExternalIdParams.builder()
