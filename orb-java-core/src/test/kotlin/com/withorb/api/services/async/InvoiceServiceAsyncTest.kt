...
class InvoiceServiceAsyncTest {
    ...
    fun create() {
      ...
      val invoiceFuture = invoiceServiceAsync.create(InvoiceCreateParams.builder()
          .currency("USD")
    ...
    fun update() {
      ...
      val invoiceFuture = invoiceServiceAsync.update(InvoiceUpdateParams.builder()
    ...
    fun fetch() {
      ...
      val invoiceFuture = invoiceServiceAsync.fetch(InvoiceFetchParams.builder()
          .invoiceId("invoice_id")
          .build())
    ...
    fun fetchUpcoming() {
      ...
      val responseFuture = invoiceServiceAsync.fetchUpcoming(InvoiceFetchUpcomingParams.builder()
    ...
    fun issue() {
      ...
      val invoiceFuture = invoiceServiceAsync.issue(InvoiceIssueParams.builder()
          .invoiceId("invoice_id")
          .synchronous(true)
          .build())
    ...
    fun markPaid() {
      ...
      val invoiceFuture = invoiceServiceAsync.markPaid(InvoiceMarkPaidParams.builder()
          .invoiceId("invoice_id")
    ...
    fun pay() {
      ...
      val invoiceFuture = invoiceServiceAsync.pay(InvoicePayParams.builder()
          .invoiceId("invoice_id")
          .build())
    ...
    fun voidInvoice() {
      ...
      val invoiceFuture = invoiceServiceAsync.voidInvoice(InvoiceVoidInvoiceParams.builder()
          .invoiceId("invoice_id")
          .build())
