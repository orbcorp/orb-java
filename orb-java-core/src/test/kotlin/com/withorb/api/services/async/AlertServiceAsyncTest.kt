...
class AlertServiceAsyncTest {
    ...
    fun retrieve() {
      ...
      val alertFuture = alertServiceAsync.retrieve(AlertRetrieveParams.builder()
          .alertId("alert_id")
          .build())
    ...
    fun update() {
      ...
      val alertFuture = alertServiceAsync.update(AlertUpdateParams.builder()
    ...
    fun createForCustomer() {
      ...
      val alertFuture = alertServiceAsync.createForCustomer(AlertCreateForCustomerParams.builder()
    ...
    fun createForExternalCustomer() {
      ...
      val alertFuture = alertServiceAsync.createForExternalCustomer(AlertCreateForExternalCustomerParams.builder()
    ...
    fun createForSubscription() {
      ...
      val alertFuture = alertServiceAsync.createForSubscription(AlertCreateForSubscriptionParams.builder()
    ...
    fun disable() {
      ...
      val alertFuture = alertServiceAsync.disable(AlertDisableParams.builder()
          .alertConfigurationId("alert_configuration_id")
          .subscriptionId("subscription_id")
          .build())
    ...
    fun enable() {
      ...
      val alertFuture = alertServiceAsync.enable(AlertEnableParams.builder()
          .alertConfigurationId("alert_configuration_id")
          .subscriptionId("subscription_id")
          .build())
