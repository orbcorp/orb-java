...
class BackfillServiceAsyncTest {
    ...
    fun create() {
      ...
      val backfillFuture = backfillServiceAsync.create(EventBackfillCreateParams.builder()
    ...
    fun close() {
      ...
      val responseFuture = backfillServiceAsync.close(EventBackfillCloseParams.builder()
    ...
    fun fetch() {
      ...
      val responseFuture = backfillServiceAsync.fetch(EventBackfillFetchParams.builder()
          .backfillId("backfill_id")
          .build())
    ...
    fun revert() {
      ...
      val responseFuture = backfillServiceAsync.revert(EventBackfillRevertParams.builder()
          .backfillId("backfill_id")
          .build())
