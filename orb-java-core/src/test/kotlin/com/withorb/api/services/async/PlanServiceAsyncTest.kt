...
class PlanServiceAsyncTest {
    ...
    fun create() {
      ...
      val planFuture = planServiceAsync.create(PlanCreateParams.builder()
          .currency("currency")
          .name("name")
    ...
    fun update() {
      ...
      val planFuture = planServiceAsync.update(PlanUpdateParams.builder()
          .planId("plan_id")
          .externalPlanId("external_plan_id")
    ...
    fun fetch() {
      ...
      val planFuture = planServiceAsync.fetch(PlanFetchParams.builder()
          .planId("plan_id")
          .build())
