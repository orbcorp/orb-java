...
class TopUpServiceTest {
    ...
    fun create() {
      ...
      val topUp = topUpService.create(CustomerCreditTopUpCreateParams.builder()
    ...
    fun list() {
      ...
      val page = topUpService.list(CustomerCreditTopUpListParams.builder()
          .customerId("customer_id")
          .build())
    ...
    fun createByExternalId() {
      ...
      val response = topUpService.createByExternalId(CustomerCreditTopUpCreateByExternalIdParams.builder()
    ...
    fun listByExternalId() {
      ...
      val page = topUpService.listByExternalId(CustomerCreditTopUpListByExternalIdParams.builder()
          .externalCustomerId("external_customer_id")
          .build())
