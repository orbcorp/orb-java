...
class BalanceTransactionServiceTest {
    ...
    fun create() {
      ...
      val balanceTransaction = balanceTransactionService.create(CustomerBalanceTransactionCreateParams.builder()
    ...
    fun list() {
      ...
      val page = balanceTransactionService.list(CustomerBalanceTransactionListParams.builder()
          .customerId("customer_id")
          .build())
