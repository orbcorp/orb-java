...
class DimensionalPriceGroupServiceAsyncTest {
    ...
    fun create() {
      ...
      val dimensionalPriceGroupFuture = dimensionalPriceGroupServiceAsync.create(DimensionalPriceGroupCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val dimensionalPriceGroupFuture = dimensionalPriceGroupServiceAsync.retrieve(DimensionalPriceGroupRetrieveParams.builder()
