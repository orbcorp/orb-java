...
class CouponServiceAsyncTest {
    ...
    fun create() {
      ...
      val couponFuture = couponServiceAsync.create(CouponCreateParams.builder()
    ...
    fun archive() {
      ...
      val couponFuture = couponServiceAsync.archive(CouponArchiveParams.builder()
          .couponId("coupon_id")
          .build())
    ...
    fun fetch() {
      ...
      val couponFuture = couponServiceAsync.fetch(CouponFetchParams.builder()
          .couponId("coupon_id")
          .build())
