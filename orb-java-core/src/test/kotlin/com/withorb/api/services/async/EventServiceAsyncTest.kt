...
class EventServiceAsyncTest {
    ...
    fun update() {
      ...
      val eventFuture = eventServiceAsync.update(EventUpdateParams.builder()
          .eventId("event_id")
    ...
    fun deprecate() {
      ...
      val responseFuture = eventServiceAsync.deprecate(EventDeprecateParams.builder()
          .eventId("event_id")
          .build())
    ...
    fun ingest() {
      ...
      val responseFuture = eventServiceAsync.ingest(EventIngestParams.builder()
    ...
    fun search() {
      ...
      val responseFuture = eventServiceAsync.search(EventSearchParams.builder()
          .addEventId("string")
