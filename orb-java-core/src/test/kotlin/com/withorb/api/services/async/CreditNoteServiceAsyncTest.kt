...
class CreditNoteServiceAsyncTest {
    ...
    fun create() {
      ...
      val creditNoteFuture = creditNoteServiceAsync.create(CreditNoteCreateParams.builder()
    ...
    fun fetch() {
      ...
      val creditNoteFuture = creditNoteServiceAsync.fetch(CreditNoteFetchParams.builder()
