...
class ExternalPlanIdServiceAsyncTest {
    ...
    fun update() {
      ...
      val planFuture = externalPlanIdServiceAsync.update(PlanExternalPlanIdUpdateParams.builder()
    ...
    fun fetch() {
      ...
      val planFuture = externalPlanIdServiceAsync.fetch(PlanExternalPlanIdFetchParams.builder()
          .externalPlanId("external_plan_id")
          .build())
