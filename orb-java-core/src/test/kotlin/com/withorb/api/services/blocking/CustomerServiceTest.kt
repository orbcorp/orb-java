...
class CustomerServiceTest {
    ...
    fun syncPaymentMethodsFromGateway() {
      ...
      customerService.syncPaymentMethodsFromGateway(CustomerSyncPaymentMethodsFromGatewayParams.builder()
          .externalCustomerId("external_customer_id")
          .build())
    }
    ...
    fun syncPaymentMethodsFromGatewayByExternalCustomerId() {
      ...
      customerService.syncPaymentMethodsFromGatewayByExternalCustomerId(CustomerSyncPaymentMethodsFromGatewayByExternalCustomerIdParams.builder()
          .customerId("customer_id")
          .build())
    }
