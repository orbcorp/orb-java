...
class MutatedSubscriptionModelTest {
    ...
    fun createMutatedSubscriptionModel() {
        ...
        assertThat(mutatedSubscriptionModel.activePlanPhaseOrder()).contains(0L)
        ...
        assertThat(mutatedSubscriptionModel.autoCollection()).contains(true)
        ...
        assertThat(mutatedSubscriptionModel.defaultInvoiceMemo()).contains("default_invoice_memo")
        ...
        assertThat(mutatedSubscriptionModel.invoicingThreshold()).contains("invoicing_threshold")
