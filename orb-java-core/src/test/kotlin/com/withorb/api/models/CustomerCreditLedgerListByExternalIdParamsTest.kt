...
class CustomerCreditLedgerListByExternalIdParamsTest {
    ...
    @Test
    fun getQueryParams() {
      val params = CustomerCreditLedgerListByExternalIdParams.builder()
          .externalCustomerId("external_customer_id")
          .createdAtGt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .createdAtGte(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .createdAtLt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      expected.put("entry_status", listOf(CustomerCreditLedgerListByExternalIdParams.EntryStatus.COMMITTED.toString()))
      expected.put("entry_type", listOf(CustomerCreditLedgerListByExternalIdParams.EntryType.INCREMENT.toString()))
