...
class CustomerCreditLedgerListByExternalIdParamsTest {
    ...
    fun queryParams() {
      ...
      expected.put("entry_status", CustomerCreditLedgerListByExternalIdParams.EntryStatus.COMMITTED.toString())
      expected.put("entry_type", CustomerCreditLedgerListByExternalIdParams.EntryType.INCREMENT.toString())
