...
internal class InvoiceAccountingSyncFailedWebhookEventTest {

    @Test
    fun create() {
        val invoiceAccountingSyncFailedWebhookEvent =
            InvoiceAccountingSyncFailedWebhookEvent.builder()
                .id("id")
                .accountingSyncRecord(
                    InvoiceAccountingSyncFailedWebhookEvent.AccountingSyncRecord.builder()
                        .id("id")
                        .customerId("customer_id")
                        .recordType(
                            InvoiceAccountingSyncFailedWebhookEvent.AccountingSyncRecord.RecordType
                                .CUSTOMER
                        )
                        .errorDetails(
                            InvoiceAccountingSyncFailedWebhookEvent.AccountingSyncRecord
                                .ErrorDetails
                                .builder()
                ...
                .properties(
                    InvoiceAccountingSyncFailedWebhookEvent.Properties.builder()
                        .connectionType("connection_type")
                        .failureReason("failure_reason")
                        .build()
                )
                .type(InvoiceAccountingSyncFailedWebhookEvent.Type.INVOICE_ACCOUNTING_SYNC_FAILED)
                .build()

        assertThat(invoiceAccountingSyncFailedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceAccountingSyncFailedWebhookEvent.accountingSyncRecord())
            .isEqualTo(
                InvoiceAccountingSyncFailedWebhookEvent.AccountingSyncRecord.builder()
                    .id("id")
                    .customerId("customer_id")
                    ...
                    .errorDetails(
                        InvoiceAccountingSyncFailedWebhookEvent.AccountingSyncRecord.ErrorDetails
                            .builder()
                            .putAdditionalProperty("foo", JsonValue.from("bar"))
                            .build()
                    )
        ...
        assertThat(invoiceAccountingSyncFailedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceAccountingSyncFailedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceAccountingSyncFailedWebhookEvent.properties())
            .isEqualTo(
                InvoiceAccountingSyncFailedWebhookEvent.Properties.builder()
                    .connectionType("connection_type")
                    .failureReason("failure_reason")
        ...
        assertThat(invoiceAccountingSyncFailedWebhookEvent.type())
            .isEqualTo(InvoiceAccountingSyncFailedWebhookEvent.Type.INVOICE_ACCOUNTING_SYNC_FAILED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceAccountingSyncFailedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceAccountingSyncFailedWebhookEvent),
                jacksonTypeRef<InvoiceAccountingSyncFailedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceAccountingSyncFailedWebhookEvent)
            .isEqualTo(invoiceAccountingSyncFailedWebhookEvent)
    }
}
