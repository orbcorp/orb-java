...
class SubscriptionsModelTest {
    ...
    @Test
    fun createSubscriptionsModel() {
        val subscriptionsModel =
            SubscriptionsModel.builder()
                ...
                .build()
        assertThat(subscriptionsModel).isNotNull
        assertThat(subscriptionsModel.data())
            .containsExactly(
                SubscriptionModel.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionsModel.paginationMetadata())
