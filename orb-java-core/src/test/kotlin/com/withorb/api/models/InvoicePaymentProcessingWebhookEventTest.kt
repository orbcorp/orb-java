...
internal class InvoicePaymentProcessingWebhookEventTest {

    @Test
    fun create() {
        val invoicePaymentProcessingWebhookEvent =
            InvoicePaymentProcessingWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoicePaymentProcessingWebhookEvent.Properties.builder()
                        .paymentProviderId("payment_provider_id")
                        .paymentProvider("payment_provider")
                        .build()
                )
                .type(InvoicePaymentProcessingWebhookEvent.Type.INVOICE_PAYMENT_PROCESSING)
                .build()

        assertThat(invoicePaymentProcessingWebhookEvent.id()).isEqualTo("id")
        assertThat(invoicePaymentProcessingWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoicePaymentProcessingWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoicePaymentProcessingWebhookEvent.properties())
            .isEqualTo(
                InvoicePaymentProcessingWebhookEvent.Properties.builder()
                    .paymentProviderId("payment_provider_id")
                    .paymentProvider("payment_provider")
        ...
        assertThat(invoicePaymentProcessingWebhookEvent.type())
            .isEqualTo(InvoicePaymentProcessingWebhookEvent.Type.INVOICE_PAYMENT_PROCESSING)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoicePaymentProcessingWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoicePaymentProcessingWebhookEvent),
                jacksonTypeRef<InvoicePaymentProcessingWebhookEvent>(),
            )

        assertThat(roundtrippedInvoicePaymentProcessingWebhookEvent)
            .isEqualTo(invoicePaymentProcessingWebhookEvent)
    }
}
