...
internal class InvoiceIssueFailedWebhookEventTest {

    @Test
    fun create() {
        val invoiceIssueFailedWebhookEvent =
            InvoiceIssueFailedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceIssueFailedWebhookEvent.Properties.builder().reason("reason").build()
                )
                .type(InvoiceIssueFailedWebhookEvent.Type.INVOICE_ISSUE_FAILED)
                .build()

        assertThat(invoiceIssueFailedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceIssueFailedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceIssueFailedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceIssueFailedWebhookEvent.properties())
            .isEqualTo(InvoiceIssueFailedWebhookEvent.Properties.builder().reason("reason").build())
        assertThat(invoiceIssueFailedWebhookEvent.type())
            .isEqualTo(InvoiceIssueFailedWebhookEvent.Type.INVOICE_ISSUE_FAILED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceIssueFailedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceIssueFailedWebhookEvent),
                jacksonTypeRef<InvoiceIssueFailedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceIssueFailedWebhookEvent)
            .isEqualTo(invoiceIssueFailedWebhookEvent)
    }
}
