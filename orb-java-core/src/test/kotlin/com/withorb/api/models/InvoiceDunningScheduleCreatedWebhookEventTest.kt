...
internal class InvoiceDunningScheduleCreatedWebhookEventTest {

    @Test
    fun create() {
        val invoiceDunningScheduleCreatedWebhookEvent =
            InvoiceDunningScheduleCreatedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceDunningScheduleCreatedWebhookEvent.Properties.builder()
                        .dunningSchedule(
                            InvoiceDunningScheduleCreatedWebhookEvent.Properties.DunningSchedule
                                .builder()
                        ...
                        .addDunningStep(
                            InvoiceDunningScheduleCreatedWebhookEvent.Properties.DunningStep
                                .builder()
                                .addAction("string")
                                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                ...
                .type(
                    InvoiceDunningScheduleCreatedWebhookEvent.Type.INVOICE_DUNNING_SCHEDULE_CREATED
                )
                .build()

        assertThat(invoiceDunningScheduleCreatedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceDunningScheduleCreatedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceDunningScheduleCreatedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceDunningScheduleCreatedWebhookEvent.properties())
            .isEqualTo(
                InvoiceDunningScheduleCreatedWebhookEvent.Properties.builder()
                    .dunningSchedule(
                        InvoiceDunningScheduleCreatedWebhookEvent.Properties.DunningSchedule
                    ...
                    .addDunningStep(
                        InvoiceDunningScheduleCreatedWebhookEvent.Properties.DunningStep.builder()
                            .addAction("string")
                            .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .executionTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(invoiceDunningScheduleCreatedWebhookEvent.type())
            .isEqualTo(
                InvoiceDunningScheduleCreatedWebhookEvent.Type.INVOICE_DUNNING_SCHEDULE_CREATED
            )
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceDunningScheduleCreatedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceDunningScheduleCreatedWebhookEvent),
                jacksonTypeRef<InvoiceDunningScheduleCreatedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceDunningScheduleCreatedWebhookEvent)
            .isEqualTo(invoiceDunningScheduleCreatedWebhookEvent)
    }
}
