...
internal class InvoicePaymentSucceededWebhookEventTest {

    @Test
    fun create() {
        val invoicePaymentSucceededWebhookEvent =
            InvoicePaymentSucceededWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoicePaymentSucceededWebhookEvent.Properties.builder()
                ...
                .type(InvoicePaymentSucceededWebhookEvent.Type.INVOICE_PAYMENT_SUCCEEDED)
                .build()

        assertThat(invoicePaymentSucceededWebhookEvent.id()).isEqualTo("id")
        assertThat(invoicePaymentSucceededWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoicePaymentSucceededWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoicePaymentSucceededWebhookEvent.properties())
            .isEqualTo(
                InvoicePaymentSucceededWebhookEvent.Properties.builder()
                    .paymentProvider("payment_provider")
                    .paymentProviderId("payment_provider_id")
        ...
        assertThat(invoicePaymentSucceededWebhookEvent.type())
            .isEqualTo(InvoicePaymentSucceededWebhookEvent.Type.INVOICE_PAYMENT_SUCCEEDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoicePaymentSucceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoicePaymentSucceededWebhookEvent),
                jacksonTypeRef<InvoicePaymentSucceededWebhookEvent>(),
            )

        assertThat(roundtrippedInvoicePaymentSucceededWebhookEvent)
            .isEqualTo(invoicePaymentSucceededWebhookEvent)
    }
}
