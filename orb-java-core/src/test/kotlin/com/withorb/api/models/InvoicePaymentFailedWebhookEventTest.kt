...
internal class InvoicePaymentFailedWebhookEventTest {

    @Test
    fun create() {
        val invoicePaymentFailedWebhookEvent =
            InvoicePaymentFailedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoicePaymentFailedWebhookEvent.Properties.builder()
                        .paymentProvider("payment_provider")
                        .paymentProviderId("payment_provider_id")
                        .paymentProviderTransactionId("payment_provider_transaction_id")
                        .build()
                )
                .type(InvoicePaymentFailedWebhookEvent.Type.INVOICE_PAYMENT_FAILED)
                .build()

        assertThat(invoicePaymentFailedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoicePaymentFailedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoicePaymentFailedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoicePaymentFailedWebhookEvent.properties())
            .isEqualTo(
                InvoicePaymentFailedWebhookEvent.Properties.builder()
                    .paymentProvider("payment_provider")
                    .paymentProviderId("payment_provider_id")
        ...
        assertThat(invoicePaymentFailedWebhookEvent.type())
            .isEqualTo(InvoicePaymentFailedWebhookEvent.Type.INVOICE_PAYMENT_FAILED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoicePaymentFailedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoicePaymentFailedWebhookEvent),
                jacksonTypeRef<InvoicePaymentFailedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoicePaymentFailedWebhookEvent)
            .isEqualTo(invoicePaymentFailedWebhookEvent)
    }
}
