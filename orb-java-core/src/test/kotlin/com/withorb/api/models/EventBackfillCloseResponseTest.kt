...
class EventBackfillCloseResponseTest {
    ...
    fun createEventBackfillCloseResponse() {
      ...
      assertThat(eventBackfillCloseResponse.closeTime()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(eventBackfillCloseResponse.revertedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(eventBackfillCloseResponse.deprecationFilter()).contains("my_numeric_property > 100 AND my_other_property = 'bar'")
    }
}
