...
internal class NewPlanMatrixWithDisplayNamePriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanMatrixWithDisplayNamePrice.licenseTypeId()).contains("license_type_id")
        ...
        assertThat(newPlanMatrixWithDisplayNamePrice.referenceId()).contains("reference_id")
    }
