...
internal class NewPlanTieredWithMinimumPriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanTieredWithMinimumPrice.licenseTypeId()).contains("license_type_id")
        ...
        assertThat(newPlanTieredWithMinimumPrice.referenceId()).contains("reference_id")
    }
