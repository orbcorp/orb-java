...
internal class InvoiceManuallyMarkedAsPaidWebhookEventTest {

    @Test
    fun create() {
        val invoiceManuallyMarkedAsPaidWebhookEvent =
            InvoiceManuallyMarkedAsPaidWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceManuallyMarkedAsPaidWebhookEvent.Properties.builder()
                        .externalId("external_id")
                        .notes("notes")
                        .paymentReceivedDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                )
                .type(InvoiceManuallyMarkedAsPaidWebhookEvent.Type.INVOICE_MANUALLY_MARKED_AS_PAID)
                .build()

        assertThat(invoiceManuallyMarkedAsPaidWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceManuallyMarkedAsPaidWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceManuallyMarkedAsPaidWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceManuallyMarkedAsPaidWebhookEvent.properties())
            .isEqualTo(
                InvoiceManuallyMarkedAsPaidWebhookEvent.Properties.builder()
                    .externalId("external_id")
                    .notes("notes")
        ...
        assertThat(invoiceManuallyMarkedAsPaidWebhookEvent.type())
            .isEqualTo(InvoiceManuallyMarkedAsPaidWebhookEvent.Type.INVOICE_MANUALLY_MARKED_AS_PAID)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceManuallyMarkedAsPaidWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceManuallyMarkedAsPaidWebhookEvent),
                jacksonTypeRef<InvoiceManuallyMarkedAsPaidWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceManuallyMarkedAsPaidWebhookEvent)
            .isEqualTo(invoiceManuallyMarkedAsPaidWebhookEvent)
    }
}
