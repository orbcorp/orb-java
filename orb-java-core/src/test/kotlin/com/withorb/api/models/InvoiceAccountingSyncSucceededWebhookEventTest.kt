...
internal class InvoiceAccountingSyncSucceededWebhookEventTest {

    @Test
    fun create() {
        val invoiceAccountingSyncSucceededWebhookEvent =
            InvoiceAccountingSyncSucceededWebhookEvent.builder()
                .id("id")
                .accountingSyncRecord(
                    InvoiceAccountingSyncSucceededWebhookEvent.AccountingSyncRecord.builder()
                        .id("id")
                        .customerId("customer_id")
                        .recordType(
                            InvoiceAccountingSyncSucceededWebhookEvent.AccountingSyncRecord
                                .RecordType
                                .CUSTOMER
                        )
                        .errorDetails(
                ...
                .properties(
                    InvoiceAccountingSyncSucceededWebhookEvent.Properties.builder()
                        .connectionType("connection_type")
                        .build()
                )
                .type(
                    InvoiceAccountingSyncSucceededWebhookEvent.Type
                        .INVOICE_ACCOUNTING_SYNC_SUCCEEDED
                )
                .build()

        assertThat(invoiceAccountingSyncSucceededWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceAccountingSyncSucceededWebhookEvent.accountingSyncRecord())
            .isEqualTo(
                InvoiceAccountingSyncSucceededWebhookEvent.AccountingSyncRecord.builder()
                    .id("id")
                    .customerId("customer_id")
                    .recordType(
                        InvoiceAccountingSyncSucceededWebhookEvent.AccountingSyncRecord.RecordType
                            .CUSTOMER
                    )
                    .errorDetails(
                        InvoiceAccountingSyncSucceededWebhookEvent.AccountingSyncRecord.ErrorDetails
                            .builder()
                            .putAdditionalProperty("foo", JsonValue.from("bar"))
                            .build()
                    )
        ...
        assertThat(invoiceAccountingSyncSucceededWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceAccountingSyncSucceededWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceAccountingSyncSucceededWebhookEvent.properties())
            .isEqualTo(
                InvoiceAccountingSyncSucceededWebhookEvent.Properties.builder()
                    .connectionType("connection_type")
                    .build()
            )
        assertThat(invoiceAccountingSyncSucceededWebhookEvent.type())
            .isEqualTo(
                InvoiceAccountingSyncSucceededWebhookEvent.Type.INVOICE_ACCOUNTING_SYNC_SUCCEEDED
            )
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceAccountingSyncSucceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceAccountingSyncSucceededWebhookEvent),
                jacksonTypeRef<InvoiceAccountingSyncSucceededWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceAccountingSyncSucceededWebhookEvent)
            .isEqualTo(invoiceAccountingSyncSucceededWebhookEvent)
    }
}
