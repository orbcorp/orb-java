...
class CustomerCostsModelTest {

    @Test
    fun createCustomerCostsModel() {
        val customerCostsModel =
            CustomerCostsModel.builder()
                .addData(
                ...
                .build()
        assertThat(customerCostsModel).isNotNull
        assertThat(customerCostsModel.data())
            .containsExactly(
                AggregatedCostModel.builder()
                    .addPerPriceCost(
                        AggregatedCostModel.PerPriceCost.builder()
