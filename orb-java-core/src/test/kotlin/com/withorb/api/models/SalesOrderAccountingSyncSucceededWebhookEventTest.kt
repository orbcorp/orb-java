...
internal class SalesOrderAccountingSyncSucceededWebhookEventTest {

    @Test
    fun create() {
        val salesOrderAccountingSyncSucceededWebhookEvent =
            SalesOrderAccountingSyncSucceededWebhookEvent.builder()
                .id("id")
                .accountingSyncRecord(
                    SalesOrderAccountingSyncSucceededWebhookEvent.AccountingSyncRecord.builder()
                        .id("id")
                ...
                .properties(
                    SalesOrderAccountingSyncSucceededWebhookEvent.Properties.builder()
                        .connectionType("connection_type")
                        .build()
                )
                .type(
                    SalesOrderAccountingSyncSucceededWebhookEvent.Type
                        .SALES_ORDER_ACCOUNTING_SYNC_SUCCEEDED
                )
                .build()

        assertThat(salesOrderAccountingSyncSucceededWebhookEvent.id()).isEqualTo("id")
        assertThat(salesOrderAccountingSyncSucceededWebhookEvent.accountingSyncRecord())
            .isEqualTo(
                SalesOrderAccountingSyncSucceededWebhookEvent.AccountingSyncRecord.builder()
                    .id("id")
                    .customerId("customer_id")
        ...
        assertThat(salesOrderAccountingSyncSucceededWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(salesOrderAccountingSyncSucceededWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(salesOrderAccountingSyncSucceededWebhookEvent.properties())
            .isEqualTo(
                SalesOrderAccountingSyncSucceededWebhookEvent.Properties.builder()
                    .connectionType("connection_type")
                    .build()
            )
        assertThat(salesOrderAccountingSyncSucceededWebhookEvent.type())
            .isEqualTo(
                SalesOrderAccountingSyncSucceededWebhookEvent.Type
                    .SALES_ORDER_ACCOUNTING_SYNC_SUCCEEDED
            )
    ...
    fun roundtrip() {
        ...
        val roundtrippedSalesOrderAccountingSyncSucceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(salesOrderAccountingSyncSucceededWebhookEvent),
                jacksonTypeRef<SalesOrderAccountingSyncSucceededWebhookEvent>(),
            )

        assertThat(roundtrippedSalesOrderAccountingSyncSucceededWebhookEvent)
            .isEqualTo(salesOrderAccountingSyncSucceededWebhookEvent)
    }
}
