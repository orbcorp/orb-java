...
internal class InvoiceManuallyMarkedAsVoidWebhookEventTest {

    @Test
    fun create() {
        val invoiceManuallyMarkedAsVoidWebhookEvent =
            InvoiceManuallyMarkedAsVoidWebhookEvent.builder()
                .id("id")
                ...
                .type(InvoiceManuallyMarkedAsVoidWebhookEvent.Type.INVOICE_MANUALLY_MARKED_AS_VOID)
                .build()

        assertThat(invoiceManuallyMarkedAsVoidWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceManuallyMarkedAsVoidWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceManuallyMarkedAsVoidWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceManuallyMarkedAsVoidWebhookEvent._properties())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(invoiceManuallyMarkedAsVoidWebhookEvent.type())
            .isEqualTo(InvoiceManuallyMarkedAsVoidWebhookEvent.Type.INVOICE_MANUALLY_MARKED_AS_VOID)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceManuallyMarkedAsVoidWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceManuallyMarkedAsVoidWebhookEvent),
                jacksonTypeRef<InvoiceManuallyMarkedAsVoidWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceManuallyMarkedAsVoidWebhookEvent)
            .isEqualTo(invoiceManuallyMarkedAsVoidWebhookEvent)
    }
}
