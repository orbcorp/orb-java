...
internal class InvoiceSyncFailedWebhookEventTest {

    @Test
    fun create() {
        val invoiceSyncFailedWebhookEvent =
            InvoiceSyncFailedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceSyncFailedWebhookEvent.Properties.builder()
                        .paymentProvider("payment_provider")
                        .paymentProviderId("payment_provider_id")
                        .build()
                )
                .type(InvoiceSyncFailedWebhookEvent.Type.INVOICE_SYNC_FAILED)
                .build()

        assertThat(invoiceSyncFailedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceSyncFailedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceSyncFailedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceSyncFailedWebhookEvent.properties())
            .isEqualTo(
                InvoiceSyncFailedWebhookEvent.Properties.builder()
                    .paymentProvider("payment_provider")
                    .paymentProviderId("payment_provider_id")
        ...
        assertThat(invoiceSyncFailedWebhookEvent.type())
            .isEqualTo(InvoiceSyncFailedWebhookEvent.Type.INVOICE_SYNC_FAILED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceSyncFailedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceSyncFailedWebhookEvent),
                jacksonTypeRef<InvoiceSyncFailedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceSyncFailedWebhookEvent)
            .isEqualTo(invoiceSyncFailedWebhookEvent)
    }
}
