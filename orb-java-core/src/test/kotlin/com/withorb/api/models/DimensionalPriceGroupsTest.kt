...
class DimensionalPriceGroupsTest {
    ...
    fun createDimensionalPriceGroups() {
      val dimensionalPriceGroups = DimensionalPriceGroups.builder()
          .addData(DimensionalPriceGroup.builder()
              .id("id")
      ...
      assertThat(dimensionalPriceGroups.data()).containsExactly(DimensionalPriceGroup.builder()
          .id("id")
          .billableMetricId("billable_metric_id")
          .addDimension("region")
          .addDimension("instance_type")
          ...
          .name("name")
          .build())
      assertThat(dimensionalPriceGroups.paginationMetadata()).isEqualTo(PaginationMetadata.builder()
          .hasMore(true)
          .nextCursor("next_cursor")
          .build())
    }
