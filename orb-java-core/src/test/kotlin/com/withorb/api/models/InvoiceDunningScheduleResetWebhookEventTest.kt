...
internal class InvoiceDunningScheduleResetWebhookEventTest {

    @Test
    fun create() {
        val invoiceDunningScheduleResetWebhookEvent =
            InvoiceDunningScheduleResetWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceDunningScheduleResetWebhookEvent.Properties.builder()
                        .dunningSchedule(
                            InvoiceDunningScheduleResetWebhookEvent.Properties.DunningSchedule
                                .builder()
                        ...
                        .previousSchedule(
                            InvoiceDunningScheduleResetWebhookEvent.Properties.PreviousSchedule
                                .builder()
                                .completionTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                                .invoiceId("invoice_id")
                ...
                .type(InvoiceDunningScheduleResetWebhookEvent.Type.INVOICE_DUNNING_SCHEDULE_RESET)
                .build()

        assertThat(invoiceDunningScheduleResetWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceDunningScheduleResetWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceDunningScheduleResetWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceDunningScheduleResetWebhookEvent.properties())
            .isEqualTo(
                InvoiceDunningScheduleResetWebhookEvent.Properties.builder()
                    .dunningSchedule(
                        InvoiceDunningScheduleResetWebhookEvent.Properties.DunningSchedule.builder()
                            .completionTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .invoiceId("invoice_id")
                            .modifiedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(invoiceDunningScheduleResetWebhookEvent.type())
            .isEqualTo(InvoiceDunningScheduleResetWebhookEvent.Type.INVOICE_DUNNING_SCHEDULE_RESET)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceDunningScheduleResetWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceDunningScheduleResetWebhookEvent),
                jacksonTypeRef<InvoiceDunningScheduleResetWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceDunningScheduleResetWebhookEvent)
            .isEqualTo(invoiceDunningScheduleResetWebhookEvent)
    }
}
