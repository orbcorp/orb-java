...
class CustomerCostListByExternalIdResponseTest {
    ...
    fun createCustomerCostListByExternalIdResponse() {
      val customerCostListByExternalIdResponse = CustomerCostListByExternalIdResponse.builder()
          .data(listOf(CustomerCostListByExternalIdResponse.Data.builder()
              .perPriceCosts(listOf(CustomerCostListByExternalIdResponse.Data.PerPriceCost.builder()
      ...
      assertThat(customerCostListByExternalIdResponse.data()).containsExactly(CustomerCostListByExternalIdResponse.Data.builder()
          .perPriceCosts(listOf(CustomerCostListByExternalIdResponse.Data.PerPriceCost.builder()
              .price(Price.ofUnitPrice(Price.UnitPrice.builder()
                  .id("id")
                  .billableMetric(Price.UnitPrice.BillableMetric.builder()
