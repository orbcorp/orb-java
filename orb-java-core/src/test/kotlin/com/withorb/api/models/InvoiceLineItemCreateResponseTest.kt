...
class InvoiceLineItemCreateResponseTest {
    ...
    fun createInvoiceLineItemCreateResponse() {
      ...
      assertThat(invoiceLineItemCreateResponse.discount()).contains(Discount.ofPercentageDiscount(Discount.PercentageDiscount.builder()
          .appliesToPriceIds(listOf("string"))
          .discountType(Discount.PercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(1.0)
          .reason("reason")
      ...
      assertThat(invoiceLineItemCreateResponse.maximum()).contains(InvoiceLineItemCreateResponse.Maximum.builder()
          .appliesToPriceIds(listOf("string"))
          .maximumAmount("maximum_amount")
          .build())
      assertThat(invoiceLineItemCreateResponse.maximumAmount()).contains("maximum_amount")
      assertThat(invoiceLineItemCreateResponse.minimum()).contains(InvoiceLineItemCreateResponse.Minimum.builder()
          .appliesToPriceIds(listOf("string"))
          .minimumAmount("minimum_amount")
          .build())
      ...
      assertThat(invoiceLineItemCreateResponse.price()).contains(Price.ofUnitPrice(Price.UnitPrice.builder()
          .id("id")
          .billableMetric(Price.UnitPrice.BillableMetric.builder()
              .id("id")
              .build())
