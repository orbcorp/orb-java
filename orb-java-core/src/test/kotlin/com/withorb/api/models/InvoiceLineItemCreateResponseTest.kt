...
class InvoiceLineItemCreateResponseTest {
    ...
    fun createInvoiceLineItemCreateResponse() {
      ...
      assertThat(invoiceLineItemCreateResponse.discount()).contains(Discount.ofPercentage(PercentageDiscount.builder()
          .addAppliesToPriceId("h74gfhdjvn7ujokd")
          .addAppliesToPriceId("7hfgtgjnbvc3ujkl")
          .discountType(PercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(0.15)
      ...
      assertThat(invoiceLineItemCreateResponse.price()).contains(Price.ofUnit(Price.UnitPrice.builder()
          .id("id")
          .billableMetric(Price.UnitPrice.BillableMetric.builder()
              .id("id")
              .build())
