...
internal class NewPlanMatrixWithAllocationPriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanMatrixWithAllocationPrice.licenseTypeId()).contains("license_type_id")
        ...
        assertThat(newPlanMatrixWithAllocationPrice.referenceId()).contains("reference_id")
    }
