...
class InvoiceTest {
    ...
    fun createInvoice() {
      ...
      assertThat(invoice.autoCollection()).isEqualTo(Invoice.AutoCollection.builder()
          ...
          .previouslyAttemptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(invoice.billingAddress()).contains(Invoice.BillingAddress.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
      ...
      assertThat(invoice.customerBalanceTransactions()).containsExactly(Invoice.CustomerBalanceTransaction.builder()
          ...
          .type(Invoice.CustomerBalanceTransaction.Type.INCREMENT)
          .build())
      assertThat(invoice.customerTaxId()).contains(Invoice.CustomerTaxId.builder()
          .country(Invoice.CustomerTaxId.Country.AD)
          .type(Invoice.CustomerTaxId.Type.AD_NRT)
          .value("value")
          .build())
      assertThat(invoice.discount()).contains(Discount.ofPercentageDiscount(Discount.PercentageDiscount.builder()
          .appliesToPriceIds(listOf("string"))
          .discountType(Discount.PercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(1.0)
          .reason("reason")
      ...
      assertThat(invoice.eligibleToIssueAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(invoice.invoicePdf()).contains("https://assets.withorb.com/invoice/rUHdhmg45vY45DX/qEAeuYePaphGMdFb")
      assertThat(invoice.invoiceSource()).isEqualTo(Invoice.InvoiceSource.SUBSCRIPTION)
      assertThat(invoice.issueFailedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(invoice.lineItems()).containsExactly(Invoice.LineItem.builder()
          ...
          .taxAmounts(listOf(Invoice.LineItem.TaxAmount.builder()
              ...
              .build()))
          .build())
      assertThat(invoice.maximum()).contains(Invoice.Maximum.builder()
          .appliesToPriceIds(listOf("string"))
          .maximumAmount("maximum_amount")
          .build())
      ...
      assertThat(invoice.minimum()).contains(Invoice.Minimum.builder()
          .appliesToPriceIds(listOf("string"))
          .minimumAmount("minimum_amount")
          .build())
      ...
      assertThat(invoice.paymentFailedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.paymentStartedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.scheduledIssueAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.shippingAddress()).contains(Invoice.ShippingAddress.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
      ...
      assertThat(invoice.subscription()).contains(Invoice.Subscription.builder()
          .id("VDGsT23osdLb84KD")
          .build())
      assertThat(invoice.subtotal()).isEqualTo("8.00")
      assertThat(invoice.syncFailedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
