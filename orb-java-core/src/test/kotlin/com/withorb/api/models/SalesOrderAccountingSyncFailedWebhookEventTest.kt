...
internal class SalesOrderAccountingSyncFailedWebhookEventTest {

    @Test
    fun create() {
        val salesOrderAccountingSyncFailedWebhookEvent =
            SalesOrderAccountingSyncFailedWebhookEvent.builder()
                .id("id")
                .accountingSyncRecord(
                    SalesOrderAccountingSyncFailedWebhookEvent.AccountingSyncRecord.builder()
                        .id("id")
                        .customerId("customer_id")
                        .recordType(
                            SalesOrderAccountingSyncFailedWebhookEvent.AccountingSyncRecord
                                .RecordType
                                .CUSTOMER
                        )
                        .errorDetails(
                ...
                .properties(
                    SalesOrderAccountingSyncFailedWebhookEvent.Properties.builder()
                        .connectionType("connection_type")
                        .failureReason("failure_reason")
                        .build()
                )
                .type(
                    SalesOrderAccountingSyncFailedWebhookEvent.Type
                        .SALES_ORDER_ACCOUNTING_SYNC_FAILED
                )
                .build()

        assertThat(salesOrderAccountingSyncFailedWebhookEvent.id()).isEqualTo("id")
        assertThat(salesOrderAccountingSyncFailedWebhookEvent.accountingSyncRecord())
            .isEqualTo(
                SalesOrderAccountingSyncFailedWebhookEvent.AccountingSyncRecord.builder()
                    .id("id")
                    .customerId("customer_id")
                    .recordType(
                        SalesOrderAccountingSyncFailedWebhookEvent.AccountingSyncRecord.RecordType
                            .CUSTOMER
                    )
                    .errorDetails(
                        SalesOrderAccountingSyncFailedWebhookEvent.AccountingSyncRecord.ErrorDetails
                            .builder()
                            .putAdditionalProperty("foo", JsonValue.from("bar"))
                            .build()
                    )
        ...
        assertThat(salesOrderAccountingSyncFailedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(salesOrderAccountingSyncFailedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(salesOrderAccountingSyncFailedWebhookEvent.properties())
            .isEqualTo(
                SalesOrderAccountingSyncFailedWebhookEvent.Properties.builder()
                    .connectionType("connection_type")
                    .failureReason("failure_reason")
        ...
        assertThat(salesOrderAccountingSyncFailedWebhookEvent.type())
            .isEqualTo(
                SalesOrderAccountingSyncFailedWebhookEvent.Type.SALES_ORDER_ACCOUNTING_SYNC_FAILED
            )
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSalesOrderAccountingSyncFailedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(salesOrderAccountingSyncFailedWebhookEvent),
                jacksonTypeRef<SalesOrderAccountingSyncFailedWebhookEvent>(),
            )

        assertThat(roundtrippedSalesOrderAccountingSyncFailedWebhookEvent)
            .isEqualTo(salesOrderAccountingSyncFailedWebhookEvent)
    }
}
