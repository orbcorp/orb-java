...
class SubscriptionFetchCostsResponseTest {
    ...
    fun createSubscriptionFetchCostsResponse() {
      val subscriptionFetchCostsResponse = SubscriptionFetchCostsResponse.builder()
          .data(listOf(SubscriptionFetchCostsResponse.Data.builder()
              .perPriceCosts(listOf(SubscriptionFetchCostsResponse.Data.PerPriceCost.builder()
      ...
      assertThat(subscriptionFetchCostsResponse.data()).containsExactly(SubscriptionFetchCostsResponse.Data.builder()
          .perPriceCosts(listOf(SubscriptionFetchCostsResponse.Data.PerPriceCost.builder()
              .price(Price.ofUnitPrice(Price.UnitPrice.builder()
                  .id("id")
                  .billableMetric(Price.UnitPrice.BillableMetric.builder()
