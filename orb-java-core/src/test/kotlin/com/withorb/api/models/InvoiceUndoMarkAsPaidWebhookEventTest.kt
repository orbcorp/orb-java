...
internal class InvoiceUndoMarkAsPaidWebhookEventTest {

    @Test
    fun create() {
        val invoiceUndoMarkAsPaidWebhookEvent =
            InvoiceUndoMarkAsPaidWebhookEvent.builder()
                .id("id")
                ...
                .type(InvoiceUndoMarkAsPaidWebhookEvent.Type.INVOICE_UNDO_MARK_AS_PAID)
                .build()

        assertThat(invoiceUndoMarkAsPaidWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceUndoMarkAsPaidWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceUndoMarkAsPaidWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceUndoMarkAsPaidWebhookEvent._properties())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(invoiceUndoMarkAsPaidWebhookEvent.type())
            .isEqualTo(InvoiceUndoMarkAsPaidWebhookEvent.Type.INVOICE_UNDO_MARK_AS_PAID)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceUndoMarkAsPaidWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceUndoMarkAsPaidWebhookEvent),
                jacksonTypeRef<InvoiceUndoMarkAsPaidWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceUndoMarkAsPaidWebhookEvent)
            .isEqualTo(invoiceUndoMarkAsPaidWebhookEvent)
    }
}
