...
internal class InvoiceDunningScheduleEndedWebhookEventTest {

    @Test
    fun create() {
        val invoiceDunningScheduleEndedWebhookEvent =
            InvoiceDunningScheduleEndedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceDunningScheduleEndedWebhookEvent.Properties.builder()
                        .dunningSchedule(
                            InvoiceDunningScheduleEndedWebhookEvent.Properties.DunningSchedule
                                .builder()
                        ...
                        .addDunningStep(
                            InvoiceDunningScheduleEndedWebhookEvent.Properties.DunningStep.builder()
                                .addAction("string")
                                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                                .executionTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                                .manuallyTriggeredAt(
                                    OffsetDateTime.parse("2019-12-27T18:11:19.117Z")
                                )
                                .modifiedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                ...
                .type(InvoiceDunningScheduleEndedWebhookEvent.Type.INVOICE_DUNNING_SCHEDULE_ENDED)
                .build()

        assertThat(invoiceDunningScheduleEndedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceDunningScheduleEndedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceDunningScheduleEndedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceDunningScheduleEndedWebhookEvent.properties())
            .isEqualTo(
                InvoiceDunningScheduleEndedWebhookEvent.Properties.builder()
                    .dunningSchedule(
                        InvoiceDunningScheduleEndedWebhookEvent.Properties.DunningSchedule.builder()
                            .completionTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .invoiceId("invoice_id")
                            .modifiedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    ...
                    .addDunningStep(
                        InvoiceDunningScheduleEndedWebhookEvent.Properties.DunningStep.builder()
                            ...
                            .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .executionTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .manuallyTriggeredAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .modifiedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .status("status")
                            .stepNumber(0L)
                            .timestamp(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(invoiceDunningScheduleEndedWebhookEvent.type())
            .isEqualTo(InvoiceDunningScheduleEndedWebhookEvent.Type.INVOICE_DUNNING_SCHEDULE_ENDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceDunningScheduleEndedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceDunningScheduleEndedWebhookEvent),
                jacksonTypeRef<InvoiceDunningScheduleEndedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceDunningScheduleEndedWebhookEvent)
            .isEqualTo(invoiceDunningScheduleEndedWebhookEvent)
    }
}
