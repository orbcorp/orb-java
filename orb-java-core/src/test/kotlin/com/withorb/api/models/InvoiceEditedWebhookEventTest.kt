...
internal class InvoiceEditedWebhookEventTest {

    @Test
    fun create() {
        val invoiceEditedWebhookEvent =
            InvoiceEditedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceEditedWebhookEvent.Properties.builder()
                        .previousAttributes(
                            InvoiceEditedWebhookEvent.Properties.PreviousAttributes.builder()
                                ...
                                .dueDate("due_date")
                                .addLineItem(
                                    InvoiceEditedWebhookEvent.Properties.PreviousAttributes.LineItem
                                        .builder()
                                        .id("id")
                                        .adjustedSubtotal("5.00")
                                        .addAdjustment(
                                ...
                                .metadata(
                                    InvoiceEditedWebhookEvent.Properties.PreviousAttributes.Metadata
                                        .builder()
                                        .putAdditionalProperty("foo", JsonValue.from("string"))
                                        .build()
                                )
                ...
                .type(InvoiceEditedWebhookEvent.Type.INVOICE_EDITED)
                .build()

        assertThat(invoiceEditedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceEditedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceEditedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceEditedWebhookEvent.properties())
            .isEqualTo(
                InvoiceEditedWebhookEvent.Properties.builder()
                    .previousAttributes(
                        InvoiceEditedWebhookEvent.Properties.PreviousAttributes.builder()
        ...
        assertThat(invoiceEditedWebhookEvent.type())
            .isEqualTo(InvoiceEditedWebhookEvent.Type.INVOICE_EDITED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceEditedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceEditedWebhookEvent),
                jacksonTypeRef<InvoiceEditedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceEditedWebhookEvent).isEqualTo(invoiceEditedWebhookEvent)
    }
}
