...
internal class NewPlanMaxGroupTieredPackagePriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanMaxGroupTieredPackagePrice.licenseTypeId()).contains("license_type_id")
        ...
        assertThat(newPlanMaxGroupTieredPackagePrice.referenceId()).contains("reference_id")
    }
