...
import com.withorb.api.models.CouponCreateParams.CouponCreateBody
...
class CouponCreateParamsTest {
    ...
    fun getBody() {
      ...
      assertThat(body.discount()).isEqualTo(CouponCreateParams.Discount.ofNewCouponPercentageDiscount(CouponCreateParams.Discount.NewCouponPercentageDiscount.builder()
          .discountType(CouponCreateParams.Discount.NewCouponPercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(42.23)
          .build()))
