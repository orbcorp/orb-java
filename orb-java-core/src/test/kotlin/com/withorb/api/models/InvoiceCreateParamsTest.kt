...
import com.withorb.api.models.InvoiceCreateParams.InvoiceCreateBody
...
class InvoiceCreateParamsTest {
    ...
    fun getBody() {
      ...
      assertThat(body.discount()).isEqualTo(Discount.ofPercentageDiscount(Discount.PercentageDiscount.builder()
          .appliesToPriceIds(listOf("string"))
          .discountType(Discount.PercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(1.0)
          .reason("reason")
