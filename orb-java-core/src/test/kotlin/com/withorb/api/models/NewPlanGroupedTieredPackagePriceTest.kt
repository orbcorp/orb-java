...
internal class NewPlanGroupedTieredPackagePriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanGroupedTieredPackagePrice.licenseTypeId()).contains("license_type_id")
        ...
        assertThat(newPlanGroupedTieredPackagePrice.referenceId()).contains("reference_id")
    }
