...
internal class InvoiceSyncSucceededWebhookEventTest {

    @Test
    fun create() {
        val invoiceSyncSucceededWebhookEvent =
            InvoiceSyncSucceededWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceSyncSucceededWebhookEvent.Properties.builder()
                        .paymentProvider("payment_provider")
                        .paymentProviderId("payment_provider_id")
                        .build()
                )
                .type(InvoiceSyncSucceededWebhookEvent.Type.INVOICE_SYNC_SUCCEEDED)
                .build()

        assertThat(invoiceSyncSucceededWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceSyncSucceededWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceSyncSucceededWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceSyncSucceededWebhookEvent.properties())
            .isEqualTo(
                InvoiceSyncSucceededWebhookEvent.Properties.builder()
                    .paymentProvider("payment_provider")
                    .paymentProviderId("payment_provider_id")
        ...
        assertThat(invoiceSyncSucceededWebhookEvent.type())
            .isEqualTo(InvoiceSyncSucceededWebhookEvent.Type.INVOICE_SYNC_SUCCEEDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceSyncSucceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceSyncSucceededWebhookEvent),
                jacksonTypeRef<InvoiceSyncSucceededWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceSyncSucceededWebhookEvent)
            .isEqualTo(invoiceSyncSucceededWebhookEvent)
    }
}
