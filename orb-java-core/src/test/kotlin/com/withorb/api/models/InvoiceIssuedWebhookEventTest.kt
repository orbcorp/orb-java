...
internal class InvoiceIssuedWebhookEventTest {

    @Test
    fun create() {
        val invoiceIssuedWebhookEvent =
            InvoiceIssuedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceIssuedWebhookEvent.Properties.builder()
                        .automaticallyMarkedAsPaid(true)
                        .build()
                )
                .type(InvoiceIssuedWebhookEvent.Type.INVOICE_ISSUED)
                .build()

        assertThat(invoiceIssuedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceIssuedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceIssuedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceIssuedWebhookEvent.properties())
            .isEqualTo(
                InvoiceIssuedWebhookEvent.Properties.builder()
                    .automaticallyMarkedAsPaid(true)
                    .build()
            )
        assertThat(invoiceIssuedWebhookEvent.type())
            .isEqualTo(InvoiceIssuedWebhookEvent.Type.INVOICE_ISSUED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceIssuedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceIssuedWebhookEvent),
                jacksonTypeRef<InvoiceIssuedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceIssuedWebhookEvent).isEqualTo(invoiceIssuedWebhookEvent)
    }
}
