...
internal class InvoiceDunningScheduleStepExecutedWebhookEventTest {

    @Test
    fun create() {
        val invoiceDunningScheduleStepExecutedWebhookEvent =
            InvoiceDunningScheduleStepExecutedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    InvoiceDunningScheduleStepExecutedWebhookEvent.Properties.builder()
                        .dunningStep(
                            InvoiceDunningScheduleStepExecutedWebhookEvent.Properties.DunningStep
                                .builder()
                                .addAction("string")
                                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                ...
                .type(
                    InvoiceDunningScheduleStepExecutedWebhookEvent.Type
                        .INVOICE_DUNNING_SCHEDULE_STEP_EXECUTED
                )
                .build()

        assertThat(invoiceDunningScheduleStepExecutedWebhookEvent.id()).isEqualTo("id")
        assertThat(invoiceDunningScheduleStepExecutedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceDunningScheduleStepExecutedWebhookEvent.invoice())
            .isEqualTo(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
        ...
        assertThat(invoiceDunningScheduleStepExecutedWebhookEvent.properties())
            .isEqualTo(
                InvoiceDunningScheduleStepExecutedWebhookEvent.Properties.builder()
                    .dunningStep(
                        InvoiceDunningScheduleStepExecutedWebhookEvent.Properties.DunningStep
        ...
        assertThat(invoiceDunningScheduleStepExecutedWebhookEvent.type())
            .isEqualTo(
                InvoiceDunningScheduleStepExecutedWebhookEvent.Type
                    .INVOICE_DUNNING_SCHEDULE_STEP_EXECUTED
            )
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceDunningScheduleStepExecutedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceDunningScheduleStepExecutedWebhookEvent),
                jacksonTypeRef<InvoiceDunningScheduleStepExecutedWebhookEvent>(),
            )

        assertThat(roundtrippedInvoiceDunningScheduleStepExecutedWebhookEvent)
            .isEqualTo(invoiceDunningScheduleStepExecutedWebhookEvent)
    }
}
