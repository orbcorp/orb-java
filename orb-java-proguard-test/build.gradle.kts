...
dependencies {
    testImplementation(project(":orb-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../orb-java-core/src/main/resources/META-INF/proguard/orb-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../orb-java-core/src/main/resources/META-INF/proguard/orb-java-core.pro",
