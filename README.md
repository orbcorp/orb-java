...
[![Maven Central](https://img.shields.io/maven-central/v/com.withorb.api/orb-java)](https://central.sonatype.com/artifact/com.withorb.api/orb-java/0.38.1)
...
```kotlin
implementation("com.withorb.api:orb-java:0.38.1")
```
